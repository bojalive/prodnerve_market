...
const PERF_DATA = [
  { serial: 'EG-4022-CBE', load: '25%', pressure: 2.1, flow: 1.42, power: 4.8, efficiency: 88.2, temp: 72, vibration: 1.2, result: 'Pass' },
  { serial: 'EG-4022-CBE', load: '50%', pressure: 4.2, flow: 2.84, power: 9.2, efficiency: 91.4, temp: 78, vibration: 1.4, result: 'Pass' },
  { serial: 'EG-4022-CBE', load: '75%', pressure: 6.3, flow: 4.18, power: 13.8, efficiency: 92.8, temp: 84, vibration: 1.8, result: 'Pass' },
  { serial: 'EG-4022-CBE', load: '100%', pressure: 8.0, flow: 5.60, power: 18.5, efficiency: 93.1, temp: 92, vibration: 2.1, result: 'Pass' },
  { serial: 'EG-4022-CBE', load: '110% (Overload)', pressure: 8.8, flow: 6.10, power: 20.8, efficiency: 91.6, temp: 98, vibration: 2.6, result: 'Pass' },
