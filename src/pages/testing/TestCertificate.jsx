...
const CERTIFICATES = [
  { certNo: 'TC-2026-04881', serial: 'IC-4022-PCL', product: 'IC-2024 Instrument Cluster', customer: 'TVS Motor Company', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kavitha S', date: '23 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04882', serial: 'AB-3018-HSR', product: 'HC-500 Hydraulic Cyl Body', customer: 'Bajaj Auto Limited', tests: 'Perf + NV + SV', wo: 'WO-2526-10006', issuedBy: 'Kavitha S', date: '23 Mar 2026', status: 'Draft' },
  { certNo: 'TC-2026-04879', serial: 'TS-1056-PNE', product: 'BR-75 Aerospace Bracket', customer: 'Ashok Leyland', tests: 'Perf + SV', wo: 'WO-2526-10003', issuedBy: 'Rajesh P', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04878', serial: 'IC-4021-PCL', product: 'IC-2024 Instrument Cluster', customer: 'TVS Motor Company', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kavitha S', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04875', serial: 'DS-2089-AMD', product: 'FT-100 Filter Housing', customer: 'Honeywell Inc', tests: 'Perf + SV + Dew Point', wo: 'WO-2526-10008', issuedBy: 'Rajesh P', date: '21 Mar 2026', status: 'Issued' },
      ...
      <div className="card" style={{ padding: 20, marginBottom: 20, border: '2px solid var(--border)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
          <div>
            ...
            <p style={{ fontSize: '.76rem', color: 'var(--text-dim)' }}>IC-4022-PCL -- IC-2024 Instrument Cluster -- TVS Motor Company</p>
          </div>
