...
const CERTIFICATES = [
  { certNo: 'TC-2026-04881', serial: 'EG-4022-WIS', product: 'AQ-C200 Centrifugal Pump', customer: 'Netafim India Ltd', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kavitha S', date: '23 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04882', serial: 'AB-3018-HSR', product: 'AQ-OW400 Openwell Pump', customer: 'Jain Irrigation Systems', tests: 'Perf + NV + SV', wo: 'WO-2526-10006', issuedBy: 'Kavitha S', date: '23 Mar 2026', status: 'Draft' },
  { certNo: 'TC-2026-04879', serial: 'TS-1056-PNE', product: 'AQ-JT75 Jet Pump', customer: 'Wilo Mather & Platt', tests: 'Perf + SV', wo: 'WO-2526-10003', issuedBy: 'Rajesh P', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04878', serial: 'EG-4021-WIS', product: 'AQ-C200 Centrifugal Pump', customer: 'Netafim India Ltd', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kavitha S', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04875', serial: 'DS-2089-AMD', product: 'FT-100 Filter Housing', customer: 'Sulzer India Ltd', tests: 'Perf + SV + Dew Point', wo: 'WO-2526-10008', issuedBy: 'Rajesh P', date: '21 Mar 2026', status: 'Issued' },
      ...
      <div className="card" style={{ padding: 20, marginBottom: 20, border: '2px solid var(--border)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
          <div>
            ...
            <p style={{ fontSize: '.76rem', color: 'var(--text-dim)' }}>EG-4022-WIS -- AQ-C200 Centrifugal Pump -- Netafim India Ltd</p>
          </div>
