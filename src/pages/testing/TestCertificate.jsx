...
const CERTIFICATES = [
  { certNo: 'TC-2026-04881', serial: 'EG-4022-CBE', product: 'EG-22 Screw Compressor', customer: 'Tata Motors Ltd', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kumar S', date: '23 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04882', serial: 'AB-3018-HSR', product: 'AB-30 Oil-Free Compressor', customer: 'Apollo Hospitals', tests: 'Perf + NV + SV', wo: 'WO-2526-10006', issuedBy: 'Kumar S', date: '23 Mar 2026', status: 'Draft' },
  { certNo: 'TC-2026-04879', serial: 'TS-1056-PNE', product: 'TS-5 Piston Compressor', customer: 'Godrej & Boyce', tests: 'Perf + SV', wo: 'WO-2526-10003', issuedBy: 'Ramesh P', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04878', serial: 'EG-4021-CBE', product: 'EG-22 Screw Compressor', customer: 'Tata Motors Ltd', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kumar S', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04875', serial: 'DS-2089-AMD', product: 'DS-10 Dryer System', customer: 'Reliance Industries', tests: 'Perf + SV + Dew Point', wo: 'WO-2526-10008', issuedBy: 'Ramesh P', date: '21 Mar 2026', status: 'Issued' },
      ...
      <div className="card" style={{ padding: 20, marginBottom: 20, border: '2px solid var(--border)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
          <div>
            ...
            <p style={{ fontSize: '.76rem', color: 'var(--text-dim)' }}>EG-4022-CBE -- EG-22 Screw Compressor -- Tata Motors Ltd</p>
          </div>
