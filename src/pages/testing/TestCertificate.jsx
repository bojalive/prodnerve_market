...
const CERTIFICATES = [
  { certNo: 'TC-2026-04881', serial: 'EG-4022-WIS', product: 'PA-450 Hub Assembly', customer: 'Siemens India Limited', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kavitha S', date: '23 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04882', serial: 'AB-3018-HSR', product: 'HC-500 Hydraulic Cyl Body', customer: 'Larsen & Toubro Limited', tests: 'Perf + NV + SV', wo: 'WO-2526-10006', issuedBy: 'Kavitha S', date: '23 Mar 2026', status: 'Draft' },
  { certNo: 'TC-2026-04879', serial: 'TS-1056-PNE', product: 'BR-75 Aerospace Bracket', customer: 'Crompton Greaves', tests: 'Perf + SV', wo: 'WO-2526-10003', issuedBy: 'Rajan P', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04878', serial: 'EG-4021-WIS', product: 'PA-450 Hub Assembly', customer: 'Siemens India Limited', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kavitha S', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04875', serial: 'DS-2089-AMD', product: 'FT-100 Filter Housing', customer: 'Bharat Heavy Electricals', tests: 'Perf + SV + Dew Point', wo: 'WO-2526-10008', issuedBy: 'Rajan P', date: '21 Mar 2026', status: 'Issued' },
      ...
      <div className="card" style={{ padding: 20, marginBottom: 20, border: '2px solid var(--border)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
          <div>
            ...
            <p style={{ fontSize: '.76rem', color: 'var(--text-dim)' }}>EG-4022-WIS -- PA-450 Hub Assembly -- Siemens India Limited</p>
          </div>
