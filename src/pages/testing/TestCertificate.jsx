...
const CERTIFICATES = [
  { certNo: 'TC-2026-04881', serial: 'EG-4022-WIS', product: 'GT-C200 Comber', customer: 'Trident Limited', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kelly S', date: '23 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04882', serial: 'AB-3018-HSR', product: 'GT-SF200 Speed Frame', customer: 'Vardhman Textiles', tests: 'Perf + NV + SV', wo: 'WO-2526-10006', issuedBy: 'Kelly S', date: '23 Mar 2026', status: 'Draft' },
  { certNo: 'TC-2026-04879', serial: 'TS-1056-PNE', product: 'GT-RF400 Ring Frame', customer: 'Kohler Co', tests: 'Perf + SV', wo: 'WO-2526-10003', issuedBy: 'Rajesh P', date: '22 Mar 2026', status: 'Issued' },
  { certNo: 'TC-2026-04878', serial: 'EG-4021-WIS', product: 'GT-C200 Comber', customer: 'Trident Limited', tests: 'Perf + NV + SV', wo: 'WO-2526-10001', issuedBy: 'Kelly S', date: '22 Mar 2026', status: 'Issued' },
