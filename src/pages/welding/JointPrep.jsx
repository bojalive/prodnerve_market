...
const FIT_UP_DATA = [
  ...
  { id: 'JP-3002', wo: 'WO-2526-10001', joint: 'Discharge Flange', wps: 'WPS-EG22-002', rootGap: 2.5, rootFace: 1.8, bevelAngle: 35, misalign: 0.6, clean: 'Pass', inspector: 'R. Selvam', date: '23 Mar 2026', status: 'Approved' },
  ...
  { id: 'JP-3005', wo: 'WO-2526-10008', joint: 'Tank Shell Seam', wps: 'WPS-DS10-001', rootGap: 3.0, rootFace: 2.0, bevelAngle: 30, misalign: 1.2, clean: 'Fail', inspector: 'S. Murugan', date: '22 Mar 2026', status: 'Rejected' },
  { id: 'JP-3006', wo: 'WO-2526-10004', joint: 'Motor Mount Bracket', wps: 'WPS-EG55-001', rootGap: 2.0, rootFace: 1.5, bevelAngle: 45, misalign: 0.5, clean: 'Pass', inspector: 'P. Kumar', date: '22 Mar 2026', status: 'Approved' },
