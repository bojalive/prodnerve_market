...
const WELD_PASSES = [
  ...
  { wo: 'WO-2526-10001', joint: 'Body to End Cover', pass: 'Fill 2', process: 'GMAW', current: 180, voltage: 24.5, speed: 120, heatInput: 2.21, filler: 'ER70S-6 \u00d81.2', gas: 'Ar+CO2 80/20', welder: 'R. Kannan', status: 'OK' },
  { wo: 'WO-2526-10001', joint: 'Body to End Cover', pass: 'Cap', process: 'GMAW', current: 200, voltage: 25.0, speed: 130, heatInput: 2.31, filler: 'ER70S-6 \u00d81.2', gas: 'Ar+CO2 80/20', welder: 'R. Kannan', status: 'OK' },
