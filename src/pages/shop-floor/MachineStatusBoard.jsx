...
const MACHINES = [
  { id: 'CNC-A01', name: 'Mori Seiki NL-2500', area: 'CNC Bay 1', status: 'Running', wo: 'WO-2526-10001', product: 'AQ-C200', progress: 82 },
  { id: 'CNC-A02', name: 'Mazak QTN-200', area: 'CNC Bay 1', status: 'Running', wo: 'WO-2526-10003', product: 'AQ-JT75', progress: 64 },
  { id: 'CNC-A03', name: 'Haas ST-30', area: 'CNC Bay 1', status: 'Running', wo: 'WO-2526-10008', product: 'AQ-S500', progress: 41 },
  { id: 'CNC-A04', name: 'Doosan Lynx 220', area: 'CNC Bay 2', status: 'Setup', wo: 'WO-2526-10012', product: 'AQ-C100', progress: 0 },
  { id: 'CNC-A05', name: 'DMG MORI CLX 350', area: 'CNC Bay 2', status: 'Running', wo: 'WO-2526-10007', product: 'AQ-JT150', progress: 55 },
  { id: 'CNC-A06', name: 'Okuma LB3000', area: 'CNC Bay 2', status: 'Down', wo: '--', product: '--', progress: 0 },
  { id: 'VMC-B01', name: 'Mazak VCN-530C', area: 'VMC Bay', status: 'Running', wo: 'WO-2526-10004', product: 'AQ-C300', progress: 91 },
  { id: 'VMC-B02', name: 'BFW BMV-45', area: 'VMC Bay', status: 'Running', wo: 'WO-2526-10006', product: 'AQ-OW400', progress: 73 },
  { id: 'VMC-B03', name: 'Makino a51nx', area: 'VMC Bay', status: 'Idle', wo: '--', product: '--', progress: 0 },
  { id: 'VMC-B04', name: 'Haas VF-3', area: 'VMC Bay', status: 'Running', wo: 'WO-2526-10011', product: 'AQ-M150', progress: 28 },
  { id: 'GRD-C01', name: 'Studer S33', area: 'Grinding', status: 'Running', wo: 'WO-2526-10001', product: 'AQ-C200', progress: 60 },
  { id: 'GRD-C02', name: 'Jones & Shipman', area: 'Grinding', status: 'Running', wo: 'WO-2526-10003', product: 'AQ-JT75', progress: 45 },
  { id: 'GRD-C03', name: 'Toyoda GE4i', area: 'Grinding', status: 'Setup', wo: 'WO-2526-10008', product: 'AQ-S500', progress: 0 },
  { id: 'GRD-C04', name: 'Micromatic GCU-250', area: 'Grinding', status: 'Idle', wo: '--', product: '--', progress: 0 },
  { id: 'ASM-D01', name: 'Assembly Station 1', area: 'Assembly', status: 'Running', wo: 'WO-2526-10004', product: 'AQ-C300', progress: 78 },
  { id: 'ASM-D02', name: 'Assembly Station 2', area: 'Assembly', status: 'Running', wo: 'WO-2526-10006', product: 'AQ-OW400', progress: 56 },
  { id: 'ASM-D03', name: 'Assembly Station 3', area: 'Assembly', status: 'Idle', wo: '--', product: '--', progress: 0 },
  { id: 'TST-E01', name: 'Test Bench 1', area: 'Testing', status: 'Running', wo: 'WO-2526-10004', product: 'AQ-C300', progress: 34 },
  { id: 'TST-E02', name: 'Test Bench 2', area: 'Testing', status: 'Down', wo: '--', product: '--', progress: 0 },
  { id: 'PNT-F01', name: 'Paint Booth A', area: 'Paint Shop', status: 'Running', wo: 'WO-2526-10007', product: 'AQ-JT150', progress: 68 },
];
