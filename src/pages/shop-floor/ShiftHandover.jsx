...
export default function ShiftHandover() {
  ...
  const RECENT_HANDOVERS = [
    { id: 'SH-3001', shift: 'C to A', date: '23 Mar 06:00', supervisor: 'Harish R', prodStatus: 'On Track', openIssues: 2, safety: 'OK', status: 'Acknowledged' },
    { id: 'SH-3002', shift: 'B to C', date: '22 Mar 22:00', supervisor: 'Aravind S', prodStatus: 'Delayed', openIssues: 4, safety: 'OK', status: 'Acknowledged' },
    { id: 'SH-3003', shift: 'A to B', date: '22 Mar 14:00', supervisor: 'Shankar M', prodStatus: 'On Track', openIssues: 1, safety: 'OK', status: 'Acknowledged' },
    { id: 'SH-3004', shift: 'C to A', date: '22 Mar 06:00', supervisor: 'Harish R', prodStatus: 'On Track', openIssues: 3, safety: 'Near Miss', status: 'Acknowledged' },
    { id: 'SH-3005', shift: 'B to C', date: '21 Mar 22:00', supervisor: 'Aravind S', prodStatus: 'On Track', openIssues: 0, safety: 'OK', status: 'Pending' },
    { id: 'SH-3006', shift: 'A to B', date: '21 Mar 14:00', supervisor: 'Shankar M', prodStatus: 'Delayed', openIssues: 5, safety: 'OK', status: 'Acknowledged' },
  ];
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 14, marginBottom: 16 }}>
          ...
          <FormField label="Supervisor">
            <select className="form-select" value={form.supervisor} onChange={e => set('supervisor', e.target.value)}>
              ...
              <option>Harish R</option><option>Shankar M</option><option>Aravind S</option>
              <option>Karthikeyan V</option><option>Sathish P</option>
            </select>
          </FormField>
        </div>
