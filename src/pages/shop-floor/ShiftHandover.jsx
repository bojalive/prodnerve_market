...
export default function ShiftHandover() {
  ...
  const RECENT_HANDOVERS = [
    ...
    { id: 'SH-3002', shift: 'B to C', date: '22 Mar 22:00', supervisor: 'Annamalai S', prodStatus: 'Delayed', openIssues: 4, safety: 'OK', status: 'Acknowledged' },
    ...
    { id: 'SH-3005', shift: 'B to C', date: '21 Mar 22:00', supervisor: 'Annamalai S', prodStatus: 'On Track', openIssues: 0, safety: 'OK', status: 'Pending' },
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 14, marginBottom: 16 }}>
          ...
          <FormField label="Supervisor">
            <select className="form-select" value={form.supervisor} onChange={e => set('supervisor', e.target.value)}>
              ...
              <option>Murugan R</option><option>Senthil M</option><option>Annamalai S</option>
              <option>Kannan V</option><option>Selvam P</option>
            </select>
          </FormField>
        </div>
