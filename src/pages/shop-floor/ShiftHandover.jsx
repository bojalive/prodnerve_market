...
export default function ShiftHandover() {
  ...
  const RECENT_HANDOVERS = [
    { id: 'SH-3001', shift: 'C to A', date: '23 Mar 06:00', supervisor: 'Ravi K', prodStatus: 'On Track', openIssues: 2, safety: 'OK', status: 'Acknowledged' },
    ...
    { id: 'SH-3003', shift: 'A to B', date: '22 Mar 14:00', supervisor: 'Suresh M', prodStatus: 'On Track', openIssues: 1, safety: 'OK', status: 'Acknowledged' },
    { id: 'SH-3004', shift: 'C to A', date: '22 Mar 06:00', supervisor: 'Ravi K', prodStatus: 'On Track', openIssues: 3, safety: 'Near Miss', status: 'Acknowledged' },
    { id: 'SH-3005', shift: 'B to C', date: '21 Mar 22:00', supervisor: 'Anand S', prodStatus: 'On Track', openIssues: 0, safety: 'OK', status: 'Pending' },
    { id: 'SH-3006', shift: 'A to B', date: '21 Mar 14:00', supervisor: 'Suresh M', prodStatus: 'Delayed', openIssues: 5, safety: 'OK', status: 'Acknowledged' },
  ];
      ...
      <div className="card" style={{ padding: 20, marginBottom: 20 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 14, marginBottom: 16 }}>
          ...
          <FormField label="Supervisor">
            <select className="form-select" value={form.supervisor} onChange={e => set('supervisor', e.target.value)}>
              ...
              <option>Ravi K</option><option>Suresh M</option><option>Anand S</option>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <FormField label="Quality Issues" hint="Rejections, NCRs raised, inspection holds">
            <textarea className="form-input" rows={2} placeholder="14 rejections (CNC-A02: 2 bore OD out of spec). NCR-2026-0089 raised for EG-22 batch." value={form.qualityNotes} onChange={e => set('qualityNotes', e.target.value)} style={{ resize: 'vertical' }} />
          </FormField>
