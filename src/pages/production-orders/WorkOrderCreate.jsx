...
const ROUTINGS = ['RT-FAB-STD (Fabrication Standard)', 'RT-CNC-HVY (CNC Mill Heavy Duty)', 'RT-MAC-STD (Machining Standard)', 'RT-ASM-STD (Assembly Standard)', 'RT-FIN-INS (Finishing & Inspection)'];
