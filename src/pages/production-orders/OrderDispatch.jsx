...
const DISPATCH_DATA = [
  ...
  { id: 'DSP-2003', wo: 'WO-2526-10001', product: 'PA-450 Hub Assembly', customer: 'Deere & Company Ltd', qty: 48, plant: 'Shawano', invoiceNo: '--', invoiceAmt: 'INR 2.33 Cr', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2004', wo: 'WO-2526-10003', product: 'BR-75 Aerospace Bracket', customer: 'Godrej & Boyce', qty: 120, plant: 'Jamshedpur', invoiceNo: '--', invoiceAmt: 'INR 50.4L', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2005', wo: 'WO-2526-10006', product: 'HC-500 Hydraulic Cyl Body', customer: 'Caterpillar Inc', qty: 8, plant: 'Shawano', invoiceNo: '--', invoiceAmt: 'INR 75.2L', vehicle: '--', dispatchDate: '--', status: 'Packing' },
  { id: 'DSP-2006', wo: 'WO-2526-10008', product: 'PA-880 Hub Assembly', customer: 'Reliance Industries', qty: 12, plant: 'Pune', invoiceNo: '--', invoiceAmt: 'INR 1.01 Cr', vehicle: '--', dispatchDate: '--', status: 'In Production' },
  ...
  { id: 'DSP-2008', wo: 'WO-2526-10011', product: 'HC-100 Hydraulic Cyl Body', customer: 'Cipla Ltd', qty: 36, plant: 'Shawano', invoiceNo: '--', invoiceAmt: 'INR 62.4L', vehicle: '--', dispatchDate: '--', status: 'In Production' },
];
