...
const DISPATCH_DATA = [
  ...
  { id: 'DSP-2004', wo: 'WO-2526-10003', product: 'GT-RF400 Ring Frame', customer: 'Kohler Co', qty: 120, plant: 'Jamshedpur', invoiceNo: '--', invoiceAmt: 'INR 50.4L', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  ...
  { id: 'DSP-2006', wo: 'WO-2526-10008', product: 'GT-DF500 Draw Frame', customer: 'Honeywell Inc', qty: 12, plant: 'Pune', invoiceNo: '--', invoiceAmt: 'INR 1.01 Cr', vehicle: '--', dispatchDate: '--', status: 'In Production' },
