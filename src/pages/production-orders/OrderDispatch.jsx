...
const DISPATCH_DATA = [
  ...
  { id: 'DSP-2003', wo: 'WO-2526-10001', product: 'PA-450 Hub Assembly', customer: 'Mahindra & Mahindra', qty: 48, plant: 'Coimbatore', invoiceNo: '--', invoiceAmt: 'INR 2.33 Cr', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2004', wo: 'WO-2526-10003', product: 'BR-75 Aerospace Bracket', customer: 'TVS Motor Company', qty: 120, plant: 'Jamshedpur', invoiceNo: '--', invoiceAmt: 'INR 50.4L', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2005', wo: 'WO-2526-10006', product: 'HC-500 Hydraulic Cyl Body', customer: 'Tata Motors', qty: 8, plant: 'Coimbatore', invoiceNo: '--', invoiceAmt: 'INR 75.2L', vehicle: '--', dispatchDate: '--', status: 'Packing' },
  { id: 'DSP-2006', wo: 'WO-2526-10008', product: 'PA-880 Hub Assembly', customer: 'Bajaj Auto', qty: 12, plant: 'Pune', invoiceNo: '--', invoiceAmt: 'INR 1.01 Cr', vehicle: '--', dispatchDate: '--', status: 'In Production' },
