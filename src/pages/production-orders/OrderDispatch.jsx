...
const DISPATCH_DATA = [
  { id: 'DSP-2001', wo: 'WO-2526-10004', product: 'AQ-C300 Centrifugal Pump', customer: 'SPML Infra Ltd', qty: 16, plant: 'Hosur', invoiceNo: 'INV-2026-4821', invoiceAmt: 'INR 99.2L', vehicle: 'TN 04 AB 1234', dispatchDate: '22 Mar 2026', status: 'Dispatched' },
  { id: 'DSP-2002', wo: 'WO-2526-10010', product: 'AQ-BS300 Booster Pump', customer: 'L&T Infrastructure', qty: 60, plant: 'Jamshedpur', invoiceNo: 'INV-2026-4822', invoiceAmt: 'INR 40.8L', vehicle: 'JH 01 CD 5678', dispatchDate: '21 Mar 2026', status: 'Dispatched' },
  { id: 'DSP-2003', wo: 'WO-2526-10001', product: 'AQ-C200 Centrifugal Pump', customer: 'Netafim India Ltd', qty: 48, plant: 'Coimbatore', invoiceNo: '--', invoiceAmt: 'INR 2.33 Cr', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2004', wo: 'WO-2526-10003', product: 'AQ-JT75 Jet Pump', customer: 'Wilo Mather & Platt', qty: 120, plant: 'Jamshedpur', invoiceNo: '--', invoiceAmt: 'INR 50.4L', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2005', wo: 'WO-2526-10006', product: 'AQ-OW400 Openwell Pump', customer: 'Jain Irrigation Systems', qty: 8, plant: 'Coimbatore', invoiceNo: '--', invoiceAmt: 'INR 75.2L', vehicle: '--', dispatchDate: '--', status: 'Packing' },
  { id: 'DSP-2006', wo: 'WO-2526-10008', product: 'AQ-S500 Submersible Pump', customer: 'Sulzer India Ltd', qty: 12, plant: 'Pune', invoiceNo: '--', invoiceAmt: 'INR 1.01 Cr', vehicle: '--', dispatchDate: '--', status: 'In Production' },
  ...
  { id: 'DSP-2008', wo: 'WO-2526-10011', product: 'AQ-M150 Monoblock Pump', customer: 'Tata Projects Ltd', qty: 36, plant: 'Coimbatore', invoiceNo: '--', invoiceAmt: 'INR 62.4L', vehicle: '--', dispatchDate: '--', status: 'In Production' },
];
