...
const DISPATCH_DATA = [
  ...
  { id: 'DSP-2003', wo: 'WO-2526-10001', product: 'IC-2024 Instrument Cluster', customer: 'TVS Motor Company', qty: 48, plant: 'Coimbatore', invoiceNo: '--', invoiceAmt: 'INR 2.33 Cr', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2004', wo: 'WO-2526-10003', product: 'BR-75 Aerospace Bracket', customer: 'Ashok Leyland', qty: 120, plant: 'Jamshedpur', invoiceNo: '--', invoiceAmt: 'INR 50.4L', vehicle: '--', dispatchDate: '--', status: 'QC Pending' },
  { id: 'DSP-2005', wo: 'WO-2526-10006', product: 'HC-500 Hydraulic Cyl Body', customer: 'Bajaj Auto Limited', qty: 8, plant: 'Coimbatore', invoiceNo: '--', invoiceAmt: 'INR 75.2L', vehicle: '--', dispatchDate: '--', status: 'Packing' },
