...
const WORK_ORDERS = [
  { wo: 'WO-2526-10001', product: 'AQ-C200 Centrifugal Pump', customer: 'Netafim India Ltd', qty: 48, plant: 'Coimbatore', start: '17 Mar 2026', end: '28 Mar 2026', priority: 'High', status: 'In Progress' },
  { wo: 'WO-2526-10002', product: 'AQ-M250 Monoblock Pump', customer: 'SPML Infra', qty: 24, plant: 'Pune', start: '18 Mar 2026', end: '30 Mar 2026', priority: 'Critical', status: 'Released' },
  { wo: 'WO-2526-10003', product: 'AQ-JT75 Jet Pump', customer: 'Wilo Mather & Platt', qty: 120, plant: 'Jamshedpur', start: '15 Mar 2026', end: '25 Mar 2026', priority: 'Medium', status: 'In Progress' },
  { wo: 'WO-2526-10004', product: 'AQ-C300 Centrifugal Pump', customer: 'SPML Infra Ltd', qty: 16, plant: 'Hosur', start: '10 Mar 2026', end: '22 Mar 2026', priority: 'High', status: 'Completed' },
  ...
  { wo: 'WO-2526-10006', product: 'AQ-OW400 Openwell Pump', customer: 'Jain Irrigation Systems', qty: 8, plant: 'Coimbatore', start: '12 Mar 2026', end: '20 Mar 2026', priority: 'Critical', status: 'In Progress' },
  { wo: 'WO-2526-10007', product: 'AQ-JT150 Jet Pump', customer: 'Grundfos India', qty: 80, plant: 'Hosur', start: '14 Mar 2026', end: '24 Mar 2026', priority: 'Medium', status: 'Released' },
  { wo: 'WO-2526-10008', product: 'AQ-S500 Submersible Pump', customer: 'Sulzer India Ltd', qty: 12, plant: 'Pune', start: '16 Mar 2026', end: '28 Mar 2026', priority: 'High', status: 'In Progress' },
  ...
  { wo: 'WO-2526-10010', product: 'AQ-BS300 Booster Pump', customer: 'L&T Infrastructure', qty: 60, plant: 'Jamshedpur', start: '11 Mar 2026', end: '21 Mar 2026', priority: 'High', status: 'Closed' },
  { wo: 'WO-2526-10011', product: 'AQ-M150 Monoblock Pump', customer: 'Tata Projects Ltd', qty: 36, plant: 'Coimbatore', start: '13 Mar 2026', end: '26 Mar 2026', priority: 'Medium', status: 'In Progress' },
  { wo: 'WO-2526-10012', product: 'AQ-C100 Centrifugal Pump', customer: 'Kirloskar Brothers Ltd', qty: 64, plant: 'Hosur', start: '21 Mar 2026', end: '04 Apr 2026', priority: 'Low', status: 'Created' },
];
