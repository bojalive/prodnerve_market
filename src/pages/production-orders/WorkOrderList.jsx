...
const WORK_ORDERS = [
  { wo: 'WO-2526-10001', product: 'EG-22 Screw Compressor', customer: 'Tata Motors Ltd', qty: 48, plant: 'Coimbatore', start: '17 Mar 2026', end: '28 Mar 2026', priority: 'High', status: 'In Progress' },
  { wo: 'WO-2526-10002', product: 'AB-15 Oil-Free Compressor', customer: 'Sun Pharma', qty: 24, plant: 'Pune', start: '18 Mar 2026', end: '30 Mar 2026', priority: 'Critical', status: 'Released' },
  { wo: 'WO-2526-10003', product: 'TS-5 Piston Compressor', customer: 'Godrej & Boyce', qty: 120, plant: 'Jamshedpur', start: '15 Mar 2026', end: '25 Mar 2026', priority: 'Medium', status: 'In Progress' },
  { wo: 'WO-2526-10004', product: 'EG-37 Screw Compressor', customer: 'Larsen & Toubro', qty: 16, plant: 'Hosur', start: '10 Mar 2026', end: '22 Mar 2026', priority: 'High', status: 'Completed' },
  ...
  { wo: 'WO-2526-10006', product: 'AB-30 Oil-Free Compressor', customer: 'Apollo Hospitals', qty: 8, plant: 'Coimbatore', start: '12 Mar 2026', end: '20 Mar 2026', priority: 'Critical', status: 'In Progress' },
  { wo: 'WO-2526-10007', product: 'TS-10 Piston Compressor', customer: 'Ashok Leyland', qty: 80, plant: 'Hosur', start: '14 Mar 2026', end: '24 Mar 2026', priority: 'Medium', status: 'Released' },
  { wo: 'WO-2526-10008', product: 'EG-55 Screw Compressor', customer: 'Reliance Industries', qty: 12, plant: 'Pune', start: '16 Mar 2026', end: '28 Mar 2026', priority: 'High', status: 'In Progress' },
  ...
  { wo: 'WO-2526-10010', product: 'TS-20 Piston Compressor', customer: 'Bharat Forge', qty: 60, plant: 'Jamshedpur', start: '11 Mar 2026', end: '21 Mar 2026', priority: 'High', status: 'Closed' },
  { wo: 'WO-2526-10011', product: 'AB-7 Oil-Free Compressor', customer: 'Cipla Ltd', qty: 36, plant: 'Coimbatore', start: '13 Mar 2026', end: '26 Mar 2026', priority: 'Medium', status: 'In Progress' },
  { wo: 'WO-2526-10012', product: 'EG-15 Screw Compressor', customer: 'Mahindra & Mahindra', qty: 64, plant: 'Hosur', start: '21 Mar 2026', end: '04 Apr 2026', priority: 'Low', status: 'Created' },
];
