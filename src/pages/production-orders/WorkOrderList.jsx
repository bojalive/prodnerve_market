...
const WORK_ORDERS = [
  { wo: 'WO-2526-10001', product: 'PA-450 Hub Assembly', customer: 'Trident Group', qty: 48, plant: 'Coimbatore', start: '17 Mar 2026', end: '28 Mar 2026', priority: 'High', status: 'In Progress' },
  ...
  { wo: 'WO-2526-10003', product: 'BR-75 Aerospace Bracket', customer: 'Vardhman Textiles', qty: 120, plant: 'Jamshedpur', start: '15 Mar 2026', end: '25 Mar 2026', priority: 'Medium', status: 'In Progress' },
  ...
  { wo: 'WO-2526-10006', product: 'HC-500 Hydraulic Cyl Body', customer: 'Raymond Limited', qty: 8, plant: 'Coimbatore', start: '12 Mar 2026', end: '20 Mar 2026', priority: 'Critical', status: 'In Progress' },
  { wo: 'WO-2526-10007', product: 'BR-150 Aerospace Bracket', customer: 'Welspun India', qty: 80, plant: 'Hosur', start: '14 Mar 2026', end: '24 Mar 2026', priority: 'Medium', status: 'Released' },
  { wo: 'WO-2526-10008', product: 'PA-880 Hub Assembly', customer: 'Aditya Birla Fashion', qty: 12, plant: 'Pune', start: '16 Mar 2026', end: '28 Mar 2026', priority: 'High', status: 'In Progress' },
  ...
  { wo: 'WO-2526-10012', product: 'PA-225 Hub Assembly', customer: 'Page Industries & Page Industries', qty: 64, plant: 'Hosur', start: '21 Mar 2026', end: '04 Apr 2026', priority: 'Low', status: 'Created' },
];
