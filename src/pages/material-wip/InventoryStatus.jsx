...
const INVENTORY_DATA = [
  ...
  { code: 'GS-EG37', desc: 'Gasket Set GT-C300', category: 'Bought Out', uom: 'Sets', onHand: 24, allocated: 32, available: -8, reorder: 20, value: 'INR 0.4L', location: 'RM-A3-09', status: 'Shortage' },
  ...
  { code: 'SL-EG22', desc: 'Shaft Seal Kit GT-C200', category: 'Bought Out', uom: 'Sets', onHand: 18, allocated: 48, available: -30, reorder: 40, value: 'INR 0.5L', location: 'RM-A3-12', status: 'Shortage' },
