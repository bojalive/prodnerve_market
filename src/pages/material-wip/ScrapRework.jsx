...
const SCRAP_REWORK = [
  { id: 'SR-2001', wo: 'WO-2526-10001', product: 'AQ-C200', part: 'Rotor Blank', type: 'Scrap', qty: 2, reason: 'Bore OD out of spec', cost: '8,400', stage: 'CNC Machining', operator: 'Murugan R', date: '23 Mar 2026', status: 'Disposed' },
  { id: 'SR-2002', wo: 'WO-2526-10003', product: 'AQ-JT75', part: 'Body Casting', type: 'Rework', qty: 4, reason: 'Surface finish Ra 1.2 (spec 0.8)', cost: '2,400', stage: 'Grinding', operator: 'Karthik V', date: '23 Mar 2026', status: 'In Rework' },
  { id: 'SR-2003', wo: 'WO-2526-10006', product: 'AQ-OW400', part: 'Housing Assembly', type: 'Scrap', qty: 1, reason: 'Leak test failure, unrepairable', cost: '18,600', stage: 'Assembly', operator: 'Dinesh N', date: '22 Mar 2026', status: 'Disposed' },
  { id: 'SR-2004', wo: 'WO-2526-10007', product: 'AQ-JT150', part: 'Piston Pin', type: 'Rework', qty: 6, reason: 'Thread gauge failure M8', cost: '1,800', stage: 'CNC Machining', operator: 'Senthil M', date: '22 Mar 2026', status: 'Completed' },
  { id: 'SR-2005', wo: 'WO-2526-10004', product: 'AQ-C300', part: 'Discharge Flange', type: 'Rework', qty: 2, reason: 'Paint peeling', cost: '1,200', stage: 'Paint / Coating', operator: 'D. Vignesh', date: '21 Mar 2026', status: 'Completed' },
  { id: 'SR-2006', wo: 'WO-2526-10008', product: 'AQ-S500', part: 'Weld Joint', type: 'Rework', qty: 1, reason: 'Weld undercut 0.6mm', cost: '3,400', stage: 'Welding', operator: 'V. Rajan', date: '20 Mar 2026', status: 'Completed' },
  { id: 'SR-2007', wo: 'WO-2526-10002', product: 'AQ-M250', part: 'Scroll Element', type: 'Scrap', qty: 1, reason: 'Crack detected during NDT', cost: '12,200', stage: 'Testing', operator: 'Kavitha S', date: '19 Mar 2026', status: 'Disposed' },
  { id: 'SR-2008', wo: 'WO-2526-10011', product: 'AQ-M150', part: 'Bearing Housing', type: 'Rework', qty: 1, reason: 'Bearing noise after assembly', cost: '2,800', stage: 'Assembly', operator: 'Arun S', date: '18 Mar 2026', status: 'Completed' },
];
