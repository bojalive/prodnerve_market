...
const SCRAP_REWORK = [
  { id: 'SR-2001', wo: 'WO-2526-10001', product: 'IC-2024', part: 'Rotor Blank', type: 'Scrap', qty: 2, reason: 'Bore OD out of spec', cost: '8,400', stage: 'CNC Machining', operator: 'Karthik V', date: '23 Mar 2026', status: 'Disposed' },
  ...
  { id: 'SR-2003', wo: 'WO-2526-10006', product: 'HC-500', part: 'Housing Assembly', type: 'Scrap', qty: 1, reason: 'Leak test failure, unrepairable', cost: '18,600', stage: 'Assembly', operator: 'Dinesh N', date: '22 Mar 2026', status: 'Disposed' },
  { id: 'SR-2004', wo: 'WO-2526-10007', product: 'BR-150', part: 'Piston Pin', type: 'Rework', qty: 6, reason: 'Thread gauge failure M8', cost: '1,800', stage: 'CNC Machining', operator: 'Saravanan T', date: '22 Mar 2026', status: 'Completed' },
  ...
  { id: 'SR-2007', wo: 'WO-2526-10002', product: 'HC-250', part: 'Scroll Element', type: 'Scrap', qty: 1, reason: 'Crack detected during NDT', cost: '12,200', stage: 'Testing', operator: 'Kavitha S', date: '19 Mar 2026', status: 'Disposed' },
  { id: 'SR-2008', wo: 'WO-2526-10011', product: 'HC-100', part: 'Bearing Housing', type: 'Rework', qty: 1, reason: 'Bearing noise after assembly', cost: '2,800', stage: 'Assembly', operator: 'Anand M', date: '18 Mar 2026', status: 'Completed' },
];
