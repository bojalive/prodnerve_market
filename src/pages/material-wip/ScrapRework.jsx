...
const SCRAP_REWORK = [
  { id: 'SR-2001', wo: 'WO-2526-10001', product: 'PA-450', part: 'Rotor Blank', type: 'Scrap', qty: 2, reason: 'Bore OD out of spec', cost: '8,400', stage: 'CNC Machining', operator: 'Harish R', date: '23 Mar 2026', status: 'Disposed' },
  { id: 'SR-2002', wo: 'WO-2526-10003', product: 'BR-75', part: 'Body Casting', type: 'Rework', qty: 4, reason: 'Surface finish Ra 1.2 (spec 0.8)', cost: '2,400', stage: 'Grinding', operator: 'Karthikeyan V', date: '23 Mar 2026', status: 'In Rework' },
  ...
  { id: 'SR-2004', wo: 'WO-2526-10007', product: 'BR-150', part: 'Piston Pin', type: 'Rework', qty: 6, reason: 'Thread gauge failure M8', cost: '1,800', stage: 'CNC Machining', operator: 'Shankar M', date: '22 Mar 2026', status: 'Completed' },
  ...
  { id: 'SR-2007', wo: 'WO-2526-10002', product: 'HC-250', part: 'Scroll Element', type: 'Scrap', qty: 1, reason: 'Crack detected during NDT', cost: '12,200', stage: 'Testing', operator: 'Keerthana S', date: '19 Mar 2026', status: 'Disposed' },
  { id: 'SR-2008', wo: 'WO-2526-10011', product: 'HC-100', part: 'Bearing Housing', type: 'Rework', qty: 1, reason: 'Bearing noise after assembly', cost: '2,800', stage: 'Assembly', operator: 'Aravind S', date: '18 Mar 2026', status: 'Completed' },
];
