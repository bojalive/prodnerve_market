...
const RECENT_ISSUES = [
  { id: 'MI-2526-10001', wo: 'WO-2526-10001', material: 'EN8 Round Bar 65mm', batch: 'HT-4482', qtyReq: 96, qtyIssued: 96, uom: 'Nos', store: 'RM-A1-03', issuedBy: 'Suresh K', receivedBy: 'Saravanan M', date: '23 Mar 2026', status: 'Issued' },
  ...
  { id: 'MI-2526-10005', wo: 'WO-2526-10008', material: 'SKF 6210-2Z Bearing', batch: 'BRG-7741', qtyReq: 24, qtyIssued: 24, uom: 'Nos', store: 'RM-D1-05', issuedBy: 'Patrick R', receivedBy: 'Saravanan M', date: '22 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10006', wo: 'WO-2526-10004', material: 'Gasket Set PA-625', batch: 'GS-0923', qtyReq: 32, qtyIssued: 32, uom: 'Sets', store: 'RM-A3-09', issuedBy: 'Anand S', receivedBy: 'Karthik V', date: '22 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10007', wo: 'WO-2526-10011', material: 'Aluminium Die Cast Cover', batch: 'ADC-3310', qtyReq: 72, qtyIssued: 60, uom: 'Nos', store: 'RM-B1-04', issuedBy: 'Suresh K', receivedBy: 'Vijay P', date: '21 Mar 2026', status: 'Partial' },
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)} title="Issue Material to Production" width={640}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <FormField label="Issued By">
            <select className="input"><option>Suresh K</option><option>Patrick R</option><option>Anand S</option></select>
          </FormField>
          <FormField label="Received By">
            <select className="input"><option>Saravanan M</option><option>Karthik V</option><option>Vijay P</option><option>Dinesh N</option></select>
          </FormField>
        </div>
