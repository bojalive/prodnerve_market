...
const RECENT_ISSUES = [
  { id: 'MI-2526-10001', wo: 'WO-2526-10001', material: 'EN8 Round Bar 65mm', batch: 'HT-4482', qtyReq: 96, qtyIssued: 96, uom: 'Nos', store: 'RM-A1-03', issuedBy: 'Harish R', receivedBy: 'Shankar M', date: '23 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10002', wo: 'WO-2526-10003', material: 'CI Casting Body 5HP', batch: 'CST-2289', qtyReq: 120, qtyIssued: 120, uom: 'Nos', store: 'RM-B2-07', issuedBy: 'Patrick R', receivedBy: 'Karthikeyan V', date: '23 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10003', wo: 'WO-2526-10006', material: 'SS304 Rotor Blank', batch: 'HT-4490', qtyReq: 16, qtyIssued: 16, uom: 'Nos', store: 'RM-A2-01', issuedBy: 'Aravind S', receivedBy: 'Sathish P', date: '23 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10004', wo: 'WO-2526-10002', material: 'Copper Winding Wire 1.2mm', batch: 'CW-1187', qtyReq: 48, qtyIssued: 45, uom: 'Kg', store: 'RM-C1-02', issuedBy: 'Harish R', receivedBy: 'Deepak N', date: '22 Mar 2026', status: 'Partial' },
  { id: 'MI-2526-10005', wo: 'WO-2526-10008', material: 'SKF 6210-2Z Bearing', batch: 'BRG-7741', qtyReq: 24, qtyIssued: 24, uom: 'Nos', store: 'RM-D1-05', issuedBy: 'Patrick R', receivedBy: 'Shankar M', date: '22 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10006', wo: 'WO-2526-10004', material: 'Gasket Set PA-625', batch: 'GS-0923', qtyReq: 32, qtyIssued: 32, uom: 'Sets', store: 'RM-A3-09', issuedBy: 'Aravind S', receivedBy: 'Karthikeyan V', date: '22 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10007', wo: 'WO-2526-10011', material: 'Aluminium Die Cast Cover', batch: 'ADC-3310', qtyReq: 72, qtyIssued: 60, uom: 'Nos', store: 'RM-B1-04', issuedBy: 'Harish R', receivedBy: 'Sathish P', date: '21 Mar 2026', status: 'Partial' },
  { id: 'MI-2526-10008', wo: 'WO-2526-10007', material: 'Epoxy Paint RAL 5015', batch: 'EP-2207', qtyReq: 80, qtyIssued: 80, uom: 'Ltr', store: 'RM-E1-01', issuedBy: 'Patrick R', receivedBy: 'Deepak N', date: '21 Mar 2026', status: 'Issued' },
];
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)} title="Issue Material to Production" width={640}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <FormField label="Issued By">
            <select className="input"><option>Harish R</option><option>Patrick R</option><option>Aravind S</option></select>
          </FormField>
          <FormField label="Received By">
            <select className="input"><option>Shankar M</option><option>Karthikeyan V</option><option>Sathish P</option><option>Deepak N</option></select>
          </FormField>
        </div>
