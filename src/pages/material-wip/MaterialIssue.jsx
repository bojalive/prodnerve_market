...
const RECENT_ISSUES = [
  ...
  { id: 'MI-2526-10003', wo: 'WO-2526-10006', material: 'SS304 Rotor Blank', batch: 'HT-4490', qtyReq: 16, qtyIssued: 16, uom: 'Nos', store: 'RM-A2-01', issuedBy: 'Anand S', receivedBy: 'Selvam P', date: '23 Mar 2026', status: 'Issued' },
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)} title="Issue Material to Production" width={640}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <FormField label="Issued By">
            <select className="input"><option>Murugan R</option><option>Patrick R</option><option>Anand S</option></select>
          </FormField>
          <FormField label="Received By">
            <select className="input"><option>Senthil M</option><option>Karthik V</option><option>Selvam P</option><option>Dinesh N</option></select>
          </FormField>
        </div>
