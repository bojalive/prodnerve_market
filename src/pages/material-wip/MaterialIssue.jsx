...
const RECENT_ISSUES = [
  ...
  { id: 'MI-2526-10004', wo: 'WO-2526-10002', material: 'Copper Winding Wire 1.2mm', batch: 'CW-1187', qtyReq: 48, qtyIssued: 45, uom: 'Kg', store: 'RM-C1-02', issuedBy: 'Mike R', receivedBy: 'Deepak N', date: '22 Mar 2026', status: 'Partial' },
  ...
  { id: 'MI-2526-10006', wo: 'WO-2526-10004', material: 'Gasket Set PA-625', batch: 'GS-0923', qtyReq: 32, qtyIssued: 32, uom: 'Sets', store: 'RM-A3-09', issuedBy: 'Andrew S', receivedBy: 'Karthik V', date: '22 Mar 2026', status: 'Issued' },
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)} title="Issue Material to Production" width={640}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <FormField label="Received By">
            <select className="input"><option>Scott M</option><option>Karthik V</option><option>Steve P</option><option>Deepak N</option></select>
          </FormField>
        </div>
