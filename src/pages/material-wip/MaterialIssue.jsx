...
const RECENT_ISSUES = [
  ...
  { id: 'MI-2526-10002', wo: 'WO-2526-10003', material: 'CI Casting Body 5HP', batch: 'CST-2289', qtyReq: 120, qtyIssued: 120, uom: 'Nos', store: 'RM-B2-07', issuedBy: 'Patrick R', receivedBy: 'Kannan V', date: '23 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10003', wo: 'WO-2526-10006', material: 'SS304 Rotor Blank', batch: 'HT-4490', qtyReq: 16, qtyIssued: 16, uom: 'Nos', store: 'RM-A2-01', issuedBy: 'Annamalai S', receivedBy: 'Selvam P', date: '23 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10004', wo: 'WO-2526-10002', material: 'Copper Winding Wire 1.2mm', batch: 'CW-1187', qtyReq: 48, qtyIssued: 45, uom: 'Kg', store: 'RM-C1-02', issuedBy: 'Murugan R', receivedBy: 'Durai N', date: '22 Mar 2026', status: 'Partial' },
  { id: 'MI-2526-10005', wo: 'WO-2526-10008', material: 'SKF 6210-2Z Bearing', batch: 'BRG-7741', qtyReq: 24, qtyIssued: 24, uom: 'Nos', store: 'RM-D1-05', issuedBy: 'Patrick R', receivedBy: 'Senthil M', date: '22 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10006', wo: 'WO-2526-10004', material: 'Gasket Set PA-625', batch: 'GS-0923', qtyReq: 32, qtyIssued: 32, uom: 'Sets', store: 'RM-A3-09', issuedBy: 'Annamalai S', receivedBy: 'Kannan V', date: '22 Mar 2026', status: 'Issued' },
  { id: 'MI-2526-10007', wo: 'WO-2526-10011', material: 'Aluminium Die Cast Cover', batch: 'ADC-3310', qtyReq: 72, qtyIssued: 60, uom: 'Nos', store: 'RM-B1-04', issuedBy: 'Murugan R', receivedBy: 'Selvam P', date: '21 Mar 2026', status: 'Partial' },
  { id: 'MI-2526-10008', wo: 'WO-2526-10007', material: 'Epoxy Paint RAL 5015', batch: 'EP-2207', qtyReq: 80, qtyIssued: 80, uom: 'Ltr', store: 'RM-E1-01', issuedBy: 'Patrick R', receivedBy: 'Durai N', date: '21 Mar 2026', status: 'Issued' },
];
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)} title="Issue Material to Production" width={640}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <FormField label="Issued By">
            <select className="input"><option>Murugan R</option><option>Patrick R</option><option>Annamalai S</option></select>
          </FormField>
          <FormField label="Received By">
            <select className="input"><option>Senthil M</option><option>Kannan V</option><option>Selvam P</option><option>Durai N</option></select>
          </FormField>
        </div>
