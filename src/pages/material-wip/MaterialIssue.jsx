...
const RECENT_ISSUES = [
  ...
  { id: 'MI-2526-10005', wo: 'WO-2526-10008', material: 'SKF 6210-2Z Bearing', batch: 'BRG-7741', qtyReq: 24, qtyIssued: 24, uom: 'Nos', store: 'RM-D1-05', issuedBy: 'Prakash R', receivedBy: 'Saravanan T', date: '22 Mar 2026', status: 'Issued' },
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)} title="Issue Material to Production" width={640}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <FormField label="Issued By">
            <select className="input"><option>Suresh K</option><option>Prakash R</option><option>Anand M</option></select>
          </FormField>
