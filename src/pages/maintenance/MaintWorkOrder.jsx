...
const WORK_ORDERS = [
  { id: 'MWO-9001', type: 'Corrective', machine: 'TST-E02', desc: 'Replace hydraulic pump seal', priority: 'Critical', assigned: 'Prabhu D', created: '23 Mar 09:15', due: '23 Mar 18:00', estCost: '12,400', status: 'In Progress' },
  { id: 'MWO-9002', type: 'Preventive', machine: 'CNC-A01', desc: 'Quarterly spindle bearing inspection', priority: 'High', assigned: 'Ganesan T', created: '23 Mar 06:00', due: '24 Mar 14:00', estCost: '8,500', status: 'Open' },
  ...
  { id: 'MWO-9004', type: 'Preventive', machine: 'GRD-C01', desc: 'Annual coolant system overhaul', priority: 'Medium', assigned: 'Ganesan T', created: '22 Mar 08:00', due: '25 Mar 18:00', estCost: '22,600', status: 'Open' },
  { id: 'MWO-9005', type: 'Improvement', machine: 'ASM-D01', desc: 'Install torque monitoring sensor', priority: 'Medium', assigned: 'Prabhu D', created: '21 Mar 10:00', due: '28 Mar 18:00', estCost: '45,000', status: 'Open' },
  ...
  { id: 'MWO-9007', type: 'Preventive', machine: 'VMC-B01', desc: 'Ball screw lubrication and check', priority: 'Medium', assigned: 'Ganesan T', created: '20 Mar 08:00', due: '23 Mar 18:00', estCost: '6,800', status: 'Completed' },
  ...
  { id: 'MWO-9009', type: 'Preventive', machine: 'CNC-A03', desc: 'Chuck jaw replacement', priority: 'Medium', assigned: 'Prabhu D', created: '19 Mar 08:00', due: '22 Mar 18:00', estCost: '9,200', status: 'Completed' },
  ...
  { id: 'MWO-9011', type: 'Corrective', machine: 'CNC-A06', desc: 'Spindle bearing replacement', priority: 'Critical', assigned: 'Ganesan T', created: '23 Mar 08:25', due: '23 Mar 12:00', estCost: '28,600', status: 'Completed' },
  { id: 'MWO-9012', type: 'Preventive', machine: 'VMC-B02', desc: 'Servo drive parameter backup', priority: 'Low', assigned: 'Prabhu D', created: '20 Mar 14:00', due: '24 Mar 18:00', estCost: '0', status: 'Open' },
];
