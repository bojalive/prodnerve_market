...
const SPARE_REQUESTS = [
  ...
  { id: 'SR-4002', part: 'Hydraulic Pump Seal Kit', partNo: 'HPS-TST-E02', machine: 'TST-E02', qty: 1, estCost: '3,800', requester: 'Praveen D', reqDate: '23 Mar 2026', need: 'Urgent', vendor: 'Parker Hannifin', status: 'Ordered' },
  ...
  { id: 'SR-4006', part: 'Guideway Wiper Set', partNo: 'GW-MAZAK-QTN', machine: 'CNC-A02', qty: 1, estCost: '4,600', requester: 'Praveen D', reqDate: '21 Mar 2026', need: 'Normal', vendor: 'Mazak India', status: 'Pending' },
  { id: 'SR-4007', part: 'Torque Sensor 50Nm', partNo: 'TS-HBM-T22-50', machine: 'ASM-D01', qty: 1, estCost: '42,000', requester: 'Praveen D', reqDate: '21 Mar 2026', need: 'Normal', vendor: 'HBM India', status: 'Pending' },
  { id: 'SR-4008', part: 'Conveyor Belt 3m', partNo: 'CB-EPP-3000', machine: 'ASM-D03', qty: 1, estCost: '6,200', requester: 'Praveen D', reqDate: '20 Mar 2026', need: 'Normal', vendor: 'Fenner India', status: 'Approved' },
];
