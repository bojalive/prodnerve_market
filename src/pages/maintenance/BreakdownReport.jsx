...
const BREAKDOWNS = [
  ...
  { id: 'BD-8002', machine: 'TST-E02', area: 'Testing', fault: 'Hydraulic pump leak', severity: 'Major', reportedBy: 'Vijay R', reportTime: '23 Mar 09:10', techAssigned: 'Praveen D', mttr: '--', rootCause: 'Seal degradation', status: 'Open' },
  ...
  { id: 'BD-8005', machine: 'ASM-D03', area: 'Assembly', fault: 'Conveyor belt slipping', severity: 'Minor', reportedBy: 'Anand M', reportTime: '22 Mar 10:15', techAssigned: 'Praveen D', mttr: '1h 10m', rootCause: 'Belt tension low', status: 'Closed' },
  { id: 'BD-8006', machine: 'CNC-A02', area: 'CNC Bay 1', fault: 'ATC arm malfunction', severity: 'Major', reportedBy: 'Saravanan T', reportTime: '21 Mar 16:45', techAssigned: 'Marcus R', mttr: '4h 20m', rootCause: 'Pneumatic cylinder wear', status: 'Closed' },
];
