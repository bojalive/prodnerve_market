...
const BREAKDOWNS = [
  { id: 'BD-8001', machine: 'CNC-A06', area: 'CNC Bay 2', fault: 'Spindle bearing seizure', severity: 'Critical', reportedBy: 'Suresh M', reportTime: '23 Mar 08:20', techAssigned: 'Ganesh T', mttr: '2h 25m', rootCause: 'Bearing end of life', status: 'Closed' },
  { id: 'BD-8002', machine: 'TST-E02', area: 'Testing', fault: 'Hydraulic pump leak', severity: 'Major', reportedBy: 'Vijay P', reportTime: '23 Mar 09:10', techAssigned: 'Prakash D', mttr: '--', rootCause: 'Seal degradation', status: 'Open' },
  { id: 'BD-8003', machine: 'PNT-F01', area: 'Paint Shop', fault: 'Spray gun nozzle clog', severity: 'Minor', reportedBy: 'Deepak N', reportTime: '23 Mar 13:00', techAssigned: 'Manoj R', mttr: '0h 40m', rootCause: 'Paint viscosity issue', status: 'Closed' },
  ...
  { id: 'BD-8005', machine: 'ASM-D03', area: 'Assembly', fault: 'Conveyor belt slipping', severity: 'Minor', reportedBy: 'Anand S', reportTime: '22 Mar 10:15', techAssigned: 'Prakash D', mttr: '1h 10m', rootCause: 'Belt tension low', status: 'Closed' },
  { id: 'BD-8006', machine: 'CNC-A02', area: 'CNC Bay 1', fault: 'ATC arm malfunction', severity: 'Major', reportedBy: 'Suresh M', reportTime: '21 Mar 16:45', techAssigned: 'Manoj R', mttr: '4h 20m', rootCause: 'Pneumatic cylinder wear', status: 'Closed' },
];
