...
const BREAKDOWNS = [
  { id: 'BD-8001', machine: 'CNC-A06', area: 'CNC Bay 2', fault: 'Spindle bearing seizure', severity: 'Critical', reportedBy: 'Saravanan T', reportTime: '23 Mar 08:20', techAssigned: 'Greg T', mttr: '2h 25m', rootCause: 'Bearing end of life', status: 'Closed' },
  { id: 'BD-8002', machine: 'TST-E02', area: 'Testing', fault: 'Hydraulic pump leak', severity: 'Major', reportedBy: 'Ramesh S', reportTime: '23 Mar 09:10', techAssigned: 'Patrick D', mttr: '--', rootCause: 'Seal degradation', status: 'Open' },
  ...
  { id: 'BD-8005', machine: 'ASM-D03', area: 'Assembly', fault: 'Conveyor belt slipping', severity: 'Minor', reportedBy: 'Anand M', reportTime: '22 Mar 10:15', techAssigned: 'Patrick D', mttr: '1h 10m', rootCause: 'Belt tension low', status: 'Closed' },
