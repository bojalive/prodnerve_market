...
const BREAKDOWNS = [
  { id: 'BD-8001', machine: 'CNC-A06', area: 'CNC Bay 2', fault: 'Spindle bearing seizure', severity: 'Critical', reportedBy: 'Senthil M', reportTime: '23 Mar 08:20', techAssigned: 'Ganesan T', mttr: '2h 25m', rootCause: 'Bearing end of life', status: 'Closed' },
  { id: 'BD-8002', machine: 'TST-E02', area: 'Testing', fault: 'Hydraulic pump leak', severity: 'Major', reportedBy: 'Suresh P', reportTime: '23 Mar 09:10', techAssigned: 'Prabhu D', mttr: '--', rootCause: 'Seal degradation', status: 'Open' },
  ...
  { id: 'BD-8004', machine: 'GRD-C04', area: 'Grinding', fault: 'Coolant pump failure', severity: 'Major', reportedBy: 'Karthik V', reportTime: '22 Mar 14:30', techAssigned: 'Ganesan T', mttr: '3h 15m', rootCause: 'Motor winding burn', status: 'Closed' },
  { id: 'BD-8005', machine: 'ASM-D03', area: 'Assembly', fault: 'Conveyor belt slipping', severity: 'Minor', reportedBy: 'Arun S', reportTime: '22 Mar 10:15', techAssigned: 'Prabhu D', mttr: '1h 10m', rootCause: 'Belt tension low', status: 'Closed' },
