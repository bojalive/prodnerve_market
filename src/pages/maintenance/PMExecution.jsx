...
const PM_CHECKLIST = [
  ...
  { id: 4, machine: 'CNC-A02', task: 'Lubricate guideway rails', freq: 'Weekly', spec: 'Per lube chart', actual: 'Done', tech: 'Prakash D', status: 'Done' },
  { id: 5, machine: 'CNC-A02', task: 'Check hydraulic oil level', freq: 'Daily', spec: 'Between marks', actual: 'OK', tech: 'Prakash D', status: 'Done' },
  { id: 6, machine: 'CNC-A02', task: 'Inspect chuck jaws', freq: 'Weekly', spec: 'No wear marks', actual: 'Minor wear noted', tech: 'Prakash D', status: 'Flag' },
  { id: 7, machine: 'VMC-B01', task: 'Clean ATC magazine', freq: 'Weekly', spec: 'All pockets clean', actual: 'Clean', tech: 'Manoj R', status: 'Done' },
  { id: 8, machine: 'VMC-B01', task: 'Check axis backlash', freq: 'Monthly', spec: '\u2264 0.010 mm', actual: '0.008 mm', tech: 'Manoj R', status: 'Done' },
  ...
  { id: 11, machine: 'ASM-D01', task: 'Inspect pneumatic fittings', freq: 'Weekly', spec: 'No leaks', actual: 'OK', tech: 'Prakash D', status: 'Done' },
  { id: 12, machine: 'ASM-D01', task: 'Calibrate torque wrench', freq: 'Monthly', spec: '\u00b12% accuracy', actual: 'Calibrated', tech: 'Prakash D', status: 'Done' },
  { id: 13, machine: 'TST-E01', task: 'Check pressure gauge accuracy', freq: 'Weekly', spec: '\u00b10.5% FS', actual: 'Within spec', tech: 'Manoj R', status: 'Done' },
  { id: 14, machine: 'PNT-F01', task: 'Clean spray booth filters', freq: 'Daily', spec: 'Replace if clogged', actual: 'Replaced', tech: 'Manoj R', status: 'Done' },
  { id: 15, machine: 'PNT-F01', task: 'Check oven temperature uniformity', freq: 'Weekly', spec: '\u00b15\u00b0C of setpoint', actual: '+3\u00b0C', tech: 'Manoj R', status: 'Done' },
];
