...
const PM_CHECKLIST = [
  { id: 1, machine: 'CNC-A01', task: 'Check spindle run-out', freq: 'Weekly', spec: '\u2264 0.005 mm', actual: '0.003 mm', tech: 'Greg T', status: 'Done' },
  { id: 2, machine: 'CNC-A01', task: 'Clean chip conveyor', freq: 'Daily', spec: 'No blockage', actual: 'Clear', tech: 'Greg T', status: 'Done' },
  { id: 3, machine: 'CNC-A01', task: 'Check coolant concentration', freq: 'Daily', spec: '6-10%', actual: '8.2%', tech: 'Greg T', status: 'Done' },
  { id: 4, machine: 'CNC-A02', task: 'Lubricate guideway rails', freq: 'Weekly', spec: 'Per lube chart', actual: 'Done', tech: 'Patrick D', status: 'Done' },
  { id: 5, machine: 'CNC-A02', task: 'Check hydraulic oil level', freq: 'Daily', spec: 'Between marks', actual: 'OK', tech: 'Patrick D', status: 'Done' },
  { id: 6, machine: 'CNC-A02', task: 'Inspect chuck jaws', freq: 'Weekly', spec: 'No wear marks', actual: 'Minor wear noted', tech: 'Patrick D', status: 'Flag' },
  ...
  { id: 9, machine: 'GRD-C01', task: 'Dress grinding wheel', freq: 'Daily', spec: 'Per schedule', actual: 'Done', tech: 'Greg T', status: 'Done' },
  { id: 10, machine: 'GRD-C01', task: 'Check wheel balance', freq: 'Weekly', spec: '\u2264 0.5 \u00b5m', actual: '0.3 \u00b5m', tech: 'Greg T', status: 'Done' },
  { id: 11, machine: 'ASM-D01', task: 'Inspect pneumatic fittings', freq: 'Weekly', spec: 'No leaks', actual: 'OK', tech: 'Patrick D', status: 'Done' },
  { id: 12, machine: 'ASM-D01', task: 'Calibrate torque wrench', freq: 'Monthly', spec: '\u00b12% accuracy', actual: 'Calibrated', tech: 'Patrick D', status: 'Done' },
