...
const NCR_DATA = [
  ...
  { id: 'NCR-2026-0088', wo: 'WO-2526-10003', product: 'GT-RF400', defect: 'Surface finish Ra 1.2\u00b5m (spec \u2264 0.8)', qty: 4, plant: 'Jamshedpur', stage: 'Grinding', detectedBy: 'QC-Lakshmi D', date: '22 Mar 2026', severity: 'Minor', disposition: 'Rework', status: 'In Progress' },
  ...
  { id: 'NCR-2026-0086', wo: 'WO-2526-10007', product: 'GT-RF450', defect: 'Thread Go/No-Go failure M8', qty: 6, plant: 'Hosur', stage: 'CNC Machining', detectedBy: 'QC-Priya S', date: '21 Mar 2026', severity: 'Minor', disposition: 'Rework', status: 'Closed' },
  { id: 'NCR-2026-0085', wo: 'WO-2526-10004', product: 'GT-C300', defect: 'Paint peeling on discharge flange', qty: 2, plant: 'Hosur', stage: 'Paint / Coating', detectedBy: 'QC-Priya S', date: '20 Mar 2026', severity: 'Minor', disposition: 'Rework', status: 'Closed' },
