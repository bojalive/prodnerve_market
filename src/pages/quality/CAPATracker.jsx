...
const CAPA_DATA = [
  ...
  { id: 'CAPA-2026-040', source: 'NCR-2026-0083', type: 'Corrective', problem: 'Weld undercut on PA-880 pressure joints', rootCause: 'Welder using incorrect travel speed', action: 'Re-train welders on WPS-EG55-001; add visual aid', owner: 'Dan N', due: '28 Mar 2026', plant: 'Pune', status: 'In Progress' },
  ...
  { id: 'CAPA-2026-036', source: 'NCR-2026-0072', type: 'Preventive', problem: 'Tool breakage events increasing on CNC-A02', rootCause: 'Tool life tracking not automated', action: 'Deploy tool life counter integration with MES', owner: 'Karl V', due: '31 Mar 2026', plant: 'Shawano', status: 'In Progress' },
  { id: 'CAPA-2026-035', source: 'Audit-2025-Q4', type: 'Preventive', problem: 'PM schedule deviation > 10% on grinding machines', rootCause: 'Production priority overriding PM schedule', action: 'Establish PM lockout windows in scheduler', owner: 'Greg T', due: '10 Mar 2026', plant: 'Shawano', status: 'Closed' },
