...
const CAPA_DATA = [
  { id: 'CAPA-2026-041', source: 'NCR-2026-0087', type: 'Corrective', problem: 'Recurring leak test failures on HC-500 series', rootCause: 'Seal groove depth variation from casting', action: 'Add 100% groove depth measurement at incoming', owner: 'Annamalai S', due: '30 Mar 2026', plant: 'Coimbatore', status: 'Open' },
  { id: 'CAPA-2026-040', source: 'NCR-2026-0083', type: 'Corrective', problem: 'Weld undercut on PA-880 pressure joints', rootCause: 'Welder using incorrect travel speed', action: 'Re-train welders on WPS-EG55-001; add visual aid', owner: 'Durai N', due: '28 Mar 2026', plant: 'Pune', status: 'In Progress' },
  ...
  { id: 'CAPA-2026-037', source: 'Customer-RCL', type: 'Corrective', problem: 'Field return: PA-450 oil carryover above spec', rootCause: 'Separator element incorrect torque', action: 'Add torque verification step in assembly SOP', owner: 'Annamalai S', due: '18 Mar 2026', plant: 'Coimbatore', status: 'Closed' },
  { id: 'CAPA-2026-036', source: 'NCR-2026-0072', type: 'Preventive', problem: 'Tool breakage events increasing on CNC-A02', rootCause: 'Tool life tracking not automated', action: 'Deploy tool life counter integration with MES', owner: 'Kannan V', due: '31 Mar 2026', plant: 'Coimbatore', status: 'In Progress' },
