...
const CAPA_DATA = [
  ...
  { id: 'CAPA-2026-038', source: 'NCR-2026-0078', type: 'Corrective', problem: 'Surface finish rejection rate increase on GT-RF400', rootCause: 'Grinding wheel dressing interval too long', action: 'Reduce dressing interval from 50 to 30 parts', owner: 'Lauren D', due: '20 Mar 2026', plant: 'Jamshedpur', status: 'Verified' },
  ...
  { id: 'CAPA-2026-034', source: 'NCR-2026-0065', type: 'Corrective', problem: 'Thread gauge failure on GT-RF450 batch', rootCause: 'Worn thread gauge not caught in calibration cycle', action: 'Reduce gauge calibration interval from 6 to 3 months', owner: 'Patricia S', due: '05 Mar 2026', plant: 'Hosur', status: 'Verified' },
];
