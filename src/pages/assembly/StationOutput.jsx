...
const STATIONS = [
  { stn: 1, name: 'Sub-Assembly A', product: 'PA-450', target: 4, actual: 4, takt: 100, operator: 'Harish R', status: 'On Track' },
  { stn: 2, name: 'Sub-Assembly B', product: 'PA-450', target: 4, actual: 4, takt: 100, operator: 'Shankar M', status: 'On Track' },
  { stn: 3, name: 'Rotor Install', product: 'PA-450', target: 4, actual: 3, takt: 88, operator: 'Karthikeyan V', status: 'Behind' },
  { stn: 4, name: 'Stator Winding', product: 'PA-450', target: 4, actual: 4, takt: 96, operator: 'Sathish P', status: 'On Track' },
  { stn: 5, name: 'Housing Fit', product: 'PA-450', target: 4, actual: 3, takt: 78, operator: 'Deepak N', status: 'Bottleneck' },
  { stn: 6, name: 'Bearing Press', product: 'PA-450', target: 4, actual: 4, takt: 95, operator: 'Aravind S', status: 'On Track' },
  ...
  { stn: 11, name: 'Final Assembly', product: 'BR-75', target: 6, actual: 6, takt: 94, operator: 'Raghu P', status: 'On Track' },
  { stn: 12, name: 'Pre-Test Check', product: 'BR-75', target: 6, actual: 5, takt: 90, operator: 'Keerthana S', status: 'Behind' },
];
