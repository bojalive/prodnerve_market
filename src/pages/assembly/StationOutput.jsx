...
const STATIONS = [
  ...
  { stn: 3, name: 'Rotor Install', product: 'PA-450', target: 4, actual: 3, takt: 88, operator: 'Karl V', status: 'Behind' },
  { stn: 4, name: 'Stator Winding', product: 'PA-450', target: 4, actual: 4, takt: 96, operator: 'Steve P', status: 'On Track' },
  { stn: 5, name: 'Housing Fit', product: 'PA-450', target: 4, actual: 3, takt: 78, operator: 'Dan N', status: 'Bottleneck' },
  ...
  { stn: 11, name: 'Final Assembly', product: 'BR-75', target: 6, actual: 6, takt: 94, operator: 'Ryan P', status: 'On Track' },
