...
const STATIONS = [
  ...
  { stn: 5, name: 'Housing Fit', product: 'PA-450', target: 4, actual: 3, takt: 78, operator: 'Dinesh N', status: 'Bottleneck' },
  { stn: 6, name: 'Bearing Press', product: 'PA-450', target: 4, actual: 4, takt: 95, operator: 'Anand S', status: 'On Track' },
