...
const STATIONS = [
  { stn: 1, name: 'Sub-Assembly A', product: 'AQ-C200', target: 4, actual: 4, takt: 100, operator: 'Murugan R', status: 'On Track' },
  { stn: 2, name: 'Sub-Assembly B', product: 'AQ-C200', target: 4, actual: 4, takt: 100, operator: 'Senthil M', status: 'On Track' },
  { stn: 3, name: 'Rotor Install', product: 'AQ-C200', target: 4, actual: 3, takt: 88, operator: 'Karthik V', status: 'Behind' },
  { stn: 4, name: 'Stator Winding', product: 'AQ-C200', target: 4, actual: 4, takt: 96, operator: 'Suresh P', status: 'On Track' },
  { stn: 5, name: 'Housing Fit', product: 'AQ-C200', target: 4, actual: 3, takt: 78, operator: 'Dinesh N', status: 'Bottleneck' },
  { stn: 6, name: 'Bearing Press', product: 'AQ-C200', target: 4, actual: 4, takt: 95, operator: 'Arun S', status: 'On Track' },
  { stn: 7, name: 'Shaft Coupling', product: 'AQ-OW400', target: 2, actual: 2, takt: 100, operator: 'Marcus R', status: 'On Track' },
  { stn: 8, name: 'Oil System', product: 'AQ-OW400', target: 2, actual: 2, takt: 98, operator: 'Ganesan T', status: 'On Track' },
  { stn: 9, name: 'Cooling Circuit', product: 'AQ-OW400', target: 2, actual: 1, takt: 82, operator: 'Prabhu D', status: 'Behind' },
  { stn: 10, name: 'Electrical Panel', product: 'VSD-200', target: 8, actual: 8, takt: 100, operator: 'Stan K', status: 'On Track' },
  { stn: 11, name: 'Final Assembly', product: 'AQ-JT75', target: 6, actual: 6, takt: 94, operator: 'Rajesh P', status: 'On Track' },
  { stn: 12, name: 'Pre-Test Check', product: 'AQ-JT75', target: 6, actual: 5, takt: 90, operator: 'Kavitha S', status: 'Behind' },
];
