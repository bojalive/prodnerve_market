...
const STATIONS = [
  ...
  { stn: 7, name: 'Shaft Coupling', product: 'GT-SF200', target: 2, actual: 2, takt: 100, operator: 'Marcus R', status: 'On Track' },
  { stn: 8, name: 'Oil System', product: 'GT-SF200', target: 2, actual: 2, takt: 98, operator: 'Ganesh T', status: 'On Track' },
  { stn: 9, name: 'Cooling Circuit', product: 'GT-SF200', target: 2, actual: 1, takt: 82, operator: 'Praveen D', status: 'Behind' },
  ...
  { stn: 12, name: 'Pre-Test Check', product: 'GT-RF400', target: 6, actual: 5, takt: 90, operator: 'Kelly S', status: 'Behind' },
];
