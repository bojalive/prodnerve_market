...
const STATIONS = [
  { stn: 1, name: 'Sub-Assembly A', product: 'PA-450', target: 4, actual: 4, takt: 100, operator: 'Suresh K', status: 'On Track' },
  { stn: 2, name: 'Sub-Assembly B', product: 'PA-450', target: 4, actual: 4, takt: 100, operator: 'Saravanan M', status: 'On Track' },
  { stn: 3, name: 'Rotor Install', product: 'PA-450', target: 4, actual: 3, takt: 88, operator: 'Karthik V', status: 'Behind' },
  { stn: 4, name: 'Stator Winding', product: 'PA-450', target: 4, actual: 4, takt: 96, operator: 'Vijay P', status: 'On Track' },
