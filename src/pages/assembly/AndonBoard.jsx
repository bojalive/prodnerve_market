...
const ANDON_CALLS = [
  { id: 'AND-201', station: 'Stn 5', type: 'Quality', desc: 'Bore dimension out of spec on housing', calledBy: 'Dinesh N', time: '23 Mar 14:05', response: '4 min', responder: 'QC - Saravanan M', status: 'Active' },
  { id: 'AND-202', station: 'Stn 9', type: 'Material', desc: 'Cooling hose kit not available', calledBy: 'Patrick D', time: '23 Mar 13:40', response: '6 min', responder: 'Store - Suresh K', status: 'Active' },
  ...
  { id: 'AND-205', station: 'Stn 1', type: 'Safety', desc: 'Oil spill near workstation', calledBy: 'Suresh K', time: '23 Mar 11:30', response: '2 min', responder: 'Safety - Greg T', status: 'Resolved' },
  ...
  { id: 'AND-207', station: 'Stn 4', type: 'Material', desc: 'Wrong seal kit delivered', calledBy: 'Vijay P', time: '23 Mar 09:20', response: '4 min', responder: 'Store - Suresh K', status: 'Resolved' },
