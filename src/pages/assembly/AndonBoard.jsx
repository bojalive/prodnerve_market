...
const ANDON_CALLS = [
  ...
  { id: 'AND-202', station: 'Stn 9', type: 'Material', desc: 'Cooling hose kit not available', calledBy: 'Prakash D', time: '23 Mar 13:40', response: '6 min', responder: 'Store - Suresh K', status: 'Active' },
  ...
  { id: 'AND-206', station: 'Stn 7', type: 'Equipment', desc: 'Pneumatic driver intermittent', calledBy: 'Manoj R', time: '23 Mar 10:45', response: '8 min', responder: 'Maint - Dinesh N', status: 'Resolved' },
  ...
  { id: 'AND-208', station: 'Stn 10', type: 'Technical', desc: 'VFD parameter setup assistance needed', calledBy: 'Senthil K', time: '23 Mar 08:50', response: '3 min', responder: 'Eng - Ryan T', status: 'Resolved' },
];
