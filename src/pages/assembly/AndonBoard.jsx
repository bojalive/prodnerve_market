...
const ANDON_CALLS = [
  { id: 'AND-201', station: 'Stn 5', type: 'Quality', desc: 'Bore dimension out of spec on housing', calledBy: 'Durai N', time: '23 Mar 14:05', response: '4 min', responder: 'QC - Senthil M', status: 'Active' },
  ...
  { id: 'AND-203', station: 'Stn 3', type: 'Equipment', desc: 'Torque wrench TW-A01 needs recalibration', calledBy: 'Kannan V', time: '23 Mar 13:15', response: '3 min', responder: 'Maint - Selvam P', status: 'Active' },
  { id: 'AND-204', station: 'Stn 12', type: 'Quality', desc: 'Compression test failure on TS-1055', calledBy: 'Kamala S', time: '23 Mar 12:10', response: '5 min', responder: 'QC - Annamalai S', status: 'Active' },
  ...
  { id: 'AND-206', station: 'Stn 7', type: 'Equipment', desc: 'Pneumatic driver intermittent', calledBy: 'Marcus R', time: '23 Mar 10:45', response: '8 min', responder: 'Maint - Durai N', status: 'Resolved' },
