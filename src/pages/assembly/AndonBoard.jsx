...
const ANDON_CALLS = [
  { id: 'AND-201', station: 'Stn 5', type: 'Quality', desc: 'Bore dimension out of spec on housing', calledBy: 'Deepak N', time: '23 Mar 14:05', response: '4 min', responder: 'QC - Scott M', status: 'Active' },
  ...
  { id: 'AND-203', station: 'Stn 3', type: 'Equipment', desc: 'Torque wrench TW-A01 needs recalibration', calledBy: 'Karthik V', time: '23 Mar 13:15', response: '3 min', responder: 'Maint - Steve P', status: 'Active' },
  ...
  { id: 'AND-205', station: 'Stn 1', type: 'Safety', desc: 'Oil spill near workstation', calledBy: 'Mike R', time: '23 Mar 11:30', response: '2 min', responder: 'Safety - Ganesh T', status: 'Resolved' },
