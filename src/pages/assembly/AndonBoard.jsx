...
const ANDON_CALLS = [
  ...
  { id: 'AND-202', station: 'Stn 9', type: 'Material', desc: 'Cooling hose kit not available', calledBy: 'Patrick D', time: '23 Mar 13:40', response: '6 min', responder: 'Store - Karthik V', status: 'Active' },
  { id: 'AND-203', station: 'Stn 3', type: 'Equipment', desc: 'Torque wrench TW-A01 needs recalibration', calledBy: 'Karthik V', time: '23 Mar 13:15', response: '3 min', responder: 'Maint - Ramesh S', status: 'Active' },
  { id: 'AND-204', station: 'Stn 12', type: 'Quality', desc: 'Compression test failure on TS-1055', calledBy: 'Kavitha S', time: '23 Mar 12:10', response: '5 min', responder: 'QC - Anand M', status: 'Active' },
  { id: 'AND-205', station: 'Stn 1', type: 'Safety', desc: 'Oil spill near workstation', calledBy: 'Karthik V', time: '23 Mar 11:30', response: '2 min', responder: 'Safety - Greg T', status: 'Resolved' },
  ...
  { id: 'AND-207', station: 'Stn 4', type: 'Material', desc: 'Wrong seal kit delivered', calledBy: 'Ramesh S', time: '23 Mar 09:20', response: '4 min', responder: 'Store - Karthik V', status: 'Resolved' },
