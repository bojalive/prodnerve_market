...
const TORQUE_DATA = [
  { stn: 3, fastener: 'Housing Bolt M10x1.5 (Pos 1)', spec: '45 \u00b1 3 Nm', actual: 46.2, tool: 'TW-A01', serial: 'EG-4022-WIS', operator: 'Karthikeyan V', time: '23 Mar 14:12', result: 'Pass' },
  { stn: 3, fastener: 'Housing Bolt M10x1.5 (Pos 2)', spec: '45 \u00b1 3 Nm', actual: 44.8, tool: 'TW-A01', serial: 'EG-4022-WIS', operator: 'Karthikeyan V', time: '23 Mar 14:13', result: 'Pass' },
  { stn: 3, fastener: 'Housing Bolt M10x1.5 (Pos 3)', spec: '45 \u00b1 3 Nm', actual: 43.1, tool: 'TW-A01', serial: 'EG-4022-WIS', operator: 'Karthikeyan V', time: '23 Mar 14:14', result: 'Pass' },
  { stn: 5, fastener: 'End Cover M8x1.25 (Pos 1)', spec: '25 \u00b1 2 Nm', actual: 27.4, tool: 'TW-B02', serial: 'EG-4022-WIS', operator: 'Deepak N', time: '23 Mar 13:45', result: 'Fail' },
  { stn: 5, fastener: 'End Cover M8x1.25 (Pos 2)', spec: '25 \u00b1 2 Nm', actual: 24.8, tool: 'TW-B02', serial: 'EG-4022-WIS', operator: 'Deepak N', time: '23 Mar 13:46', result: 'Pass' },
  { stn: 6, fastener: 'Bearing Retainer M6x1.0', spec: '12 \u00b1 1.5 Nm', actual: 11.8, tool: 'TW-C03', serial: 'AB-3018-HSR', operator: 'Aravind S', time: '23 Mar 13:20', result: 'Pass' },
  ...
  { stn: 11, fastener: 'Base Plate M10x1.5', spec: '45 \u00b1 3 Nm', actual: 44.5, tool: 'TW-A01', serial: 'TS-1055-PNE', operator: 'Raghu P', time: '23 Mar 12:30', result: 'Pass' },
];
