...
const TEST_RESULTS = [
  ...
  { serial: 'EG-4022-WIS', test: 'Electrical Continuity', spec: 'Resistance < 0.5\u03A9', actual: '0.3\u03A9', station: 'Stn 4', tester: 'Suresh P', time: '23 Mar 13:30', result: 'Pass' },
  ...
  { serial: 'AB-3018-HSR', test: 'Oil Circuit Flow', spec: '\u2265 2 L/min @ 2 bar', actual: '2.4 L/min', station: 'Stn 8', tester: 'Ganesan T', time: '23 Mar 12:40', result: 'Pass' },
