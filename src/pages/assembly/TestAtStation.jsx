...
const TEST_RESULTS = [
  { serial: 'IC-4022-PCL', test: 'Rotation Check', spec: 'Free rotation, no binding', actual: 'Smooth', station: 'Stn 3', tester: 'Karthik V', time: '23 Mar 14:20', result: 'Pass' },
  { serial: 'IC-4022-PCL', test: 'Leak Test (Low Pressure)', spec: '\u2264 0.5 cc/min @ 3 bar', actual: '0.2 cc/min', station: 'Stn 5', tester: 'Dinesh N', time: '23 Mar 13:50', result: 'Pass' },
  { serial: 'IC-4022-PCL', test: 'Electrical Continuity', spec: 'Resistance < 0.5\u03A9', actual: '0.3\u03A9', station: 'Stn 4', tester: 'Ramesh S', time: '23 Mar 13:30', result: 'Pass' },
