...
const INSPECTION_DATA = [
  { serial: 'EG-4022-WIS', wo: 'WO-2526-10001', product: 'GT-C200', dftSpec: '60-80 \u00b5m', dftActual: 72, adhesion: '5B (Best)', gloss: 82, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Kannan', date: '23 Mar 2026', result: 'Pass' },
  { serial: 'EG-4023-WIS', wo: 'WO-2526-10001', product: 'GT-C200', dftSpec: '60-80 \u00b5m', dftActual: 68, adhesion: '5B (Best)', gloss: 80, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Kannan', date: '23 Mar 2026', result: 'Pass' },
  { serial: 'TS-1055-PNE', wo: 'WO-2526-10003', product: 'GT-RF400', dftSpec: '50-70 \u00b5m', dftActual: 58, adhesion: '4B (Good)', gloss: 75, color: 'RAL 7035 (Pass)', visual: 'No defects', inspector: 'D. Vignesh', date: '23 Mar 2026', result: 'Pass' },
  { serial: 'AB-3018-HSR', wo: 'WO-2526-10006', product: 'GT-SF200', dftSpec: '60-80 \u00b5m', dftActual: 82, adhesion: '5B (Best)', gloss: 78, color: 'RAL 5015 (Pass)', visual: 'Minor orange peel', inspector: 'R. Kannan', date: '23 Mar 2026', result: 'Pass' },
  { serial: 'TS-1056-PNE', wo: 'WO-2526-10003', product: 'GT-RF400', dftSpec: '50-70 \u00b5m', dftActual: 45, adhesion: '3B (Fair)', gloss: 65, color: 'RAL 7035 (Pass)', visual: 'Thin spot on base', inspector: 'D. Vignesh', date: '22 Mar 2026', result: 'Fail' },
  { serial: 'EG-4021-WIS', wo: 'WO-2526-10001', product: 'GT-C200', dftSpec: '60-80 \u00b5m', dftActual: 74, adhesion: '5B (Best)', gloss: 84, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Kannan', date: '22 Mar 2026', result: 'Pass' },
  ...
  { serial: 'DS-2089-AMD', wo: 'WO-2526-10008', product: 'DS-10', dftSpec: '60-80 \u00b5m', dftActual: 70, adhesion: '4B (Good)', gloss: 76, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Kannan', date: '21 Mar 2026', result: 'Pass' },
];
