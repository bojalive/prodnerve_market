...
const INSPECTION_DATA = [
  { serial: 'EG-4022-WIS', wo: 'WO-2526-10001', product: 'GT-C200', dftSpec: '60-80 \u00b5m', dftActual: 72, adhesion: '5B (Best)', gloss: 82, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Hansen', date: '23 Mar 2026', result: 'Pass' },
  { serial: 'EG-4023-WIS', wo: 'WO-2526-10001', product: 'GT-C200', dftSpec: '60-80 \u00b5m', dftActual: 68, adhesion: '5B (Best)', gloss: 80, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Hansen', date: '23 Mar 2026', result: 'Pass' },
  ...
  { serial: 'AB-3018-HSR', wo: 'WO-2526-10006', product: 'GT-SF200', dftSpec: '60-80 \u00b5m', dftActual: 82, adhesion: '5B (Best)', gloss: 78, color: 'RAL 5015 (Pass)', visual: 'Minor orange peel', inspector: 'R. Hansen', date: '23 Mar 2026', result: 'Pass' },
  ...
  { serial: 'EG-4021-WIS', wo: 'WO-2526-10001', product: 'GT-C200', dftSpec: '60-80 \u00b5m', dftActual: 74, adhesion: '5B (Best)', gloss: 84, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Hansen', date: '22 Mar 2026', result: 'Pass' },
