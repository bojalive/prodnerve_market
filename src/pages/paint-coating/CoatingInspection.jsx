...
const INSPECTION_DATA = [
  { serial: 'IC-4022-PCL', wo: 'WO-2526-10001', product: 'IC-2024', dftSpec: '60-80 \u00b5m', dftActual: 72, adhesion: '5B (Best)', gloss: 82, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Hansen', date: '23 Mar 2026', result: 'Pass' },
  { serial: 'IC-4023-PCL', wo: 'WO-2526-10001', product: 'IC-2024', dftSpec: '60-80 \u00b5m', dftActual: 68, adhesion: '5B (Best)', gloss: 80, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Hansen', date: '23 Mar 2026', result: 'Pass' },
  ...
  { serial: 'IC-4021-PCL', wo: 'WO-2526-10001', product: 'IC-2024', dftSpec: '60-80 \u00b5m', dftActual: 74, adhesion: '5B (Best)', gloss: 84, color: 'RAL 5015 (Pass)', visual: 'No defects', inspector: 'R. Hansen', date: '22 Mar 2026', result: 'Pass' },
