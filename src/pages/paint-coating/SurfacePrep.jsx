...
const MOCK_RECORDS = [
  { wo: 'WO-2026-0451', serial: 'EG-4022-CBE', method: 'Shot Blast', grade: 'SA 2.5', profile: 52, clean: 'Pass', date: '23-Mar-2026 08:15', operator: 'M. Kannan' },
  { wo: 'WO-2026-0449', serial: 'AB-3018-HSR', method: 'Chemical', grade: 'St 3', profile: 44, clean: 'Pass', date: '23-Mar-2026 08:40', operator: 'R. Selvam' },
  ...
  { wo: 'WO-2026-0445', serial: 'EG-4023-CBE', method: 'Chemical', grade: 'St 3', profile: 46, clean: 'Pass', date: '23-Mar-2026 10:20', operator: 'R. Selvam' },
  { wo: 'WO-2026-0444', serial: 'AB-3019-HSR', method: 'Shot Blast', grade: 'SA 2.5', profile: 49, clean: 'Pass', date: '23-Mar-2026 10:45', operator: 'S. Murugan' },
