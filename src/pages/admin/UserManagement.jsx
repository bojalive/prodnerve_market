...
const USERS = [
  ...
  { id: 'USR-002', name: 'Senthil Menon', email: 'suresh.m@company.com', role: 'Plant Head', plant: 'Coimbatore', dept: 'Operations', lastLogin: '23 Mar 13:45', status: 'Active' },
  { id: 'USR-003', name: 'Patricia Sharma', email: 'priya.s@company.com', role: 'Plant Head', plant: 'Hosur', dept: 'Operations', lastLogin: '23 Mar 12:30', status: 'Active' },
  ...
  { id: 'USR-005', name: 'Arun Subramanian', email: 'anand.s@company.com', role: 'Quality Mgr', plant: 'Coimbatore', dept: 'Quality', lastLogin: '23 Mar 11:20', status: 'Active' },
  { id: 'USR-006', name: 'Dinesh Nair', email: 'deepak.n@company.com', role: 'Maintenance Mgr', plant: 'Pune', dept: 'Maintenance', lastLogin: '22 Mar 16:45', status: 'Active' },
  { id: 'USR-007', name: 'Murugan Krishnan', email: 'ravi.k@company.com', role: 'Supervisor', plant: 'Coimbatore', dept: 'CNC', lastLogin: '23 Mar 14:00', status: 'Active' },
  ...
  { id: 'USR-009', name: 'Ganesan Thiagarajan', email: 'ganesh.t@company.com', role: 'Supervisor', plant: 'Coimbatore', dept: 'Maintenance', lastLogin: '23 Mar 13:00', status: 'Active' },
  { id: 'USR-010', name: 'Suresh Patrick', email: 'vijay.p@company.com', role: 'Operator', plant: 'Coimbatore', dept: 'Assembly', lastLogin: '23 Mar 06:05', status: 'Active' },
  { id: 'USR-011', name: 'Lauren Devi', email: 'lakshmi.d@company.com', role: 'Quality Inspector', plant: 'Pune', dept: 'Quality', lastLogin: '22 Mar 14:20', status: 'Active' },
  ...
  { id: 'USR-015', name: 'Stan Mason', email: 'senthil.m@company.com', role: 'Plant Head', plant: 'Ahmedabad', dept: 'Operations', lastLogin: '23 Mar 11:00', status: 'Active' },
];
