...
const PROD_DATA = [
  { product: 'AQ-C200 Centrifugal Pump', plant: 'Coimbatore', planned: 48, actual: 42, var: -12.5, mtdPlan: 180, mtdActual: 164, status: 'Behind' },
  { product: 'AQ-M250 Monoblock Pump', plant: 'Pune', planned: 24, actual: 18, var: -25.0, mtdPlan: 96, mtdActual: 78, status: 'Behind' },
  { product: 'AQ-JT75 Jet Pump', plant: 'Jamshedpur', planned: 120, actual: 115, var: -4.2, mtdPlan: 480, mtdActual: 462, status: 'On Track' },
  { product: 'AQ-C300 Centrifugal Pump', plant: 'Hosur', planned: 16, actual: 16, var: 0.0, mtdPlan: 64, mtdActual: 64, status: 'On Track' },
  { product: 'VSD-200 Controller', plant: 'Ahmedabad', planned: 200, actual: 195, var: -2.5, mtdPlan: 800, mtdActual: 788, status: 'On Track' },
  { product: 'AQ-OW400 Openwell Pump', plant: 'Coimbatore', planned: 8, actual: 6, var: -25.0, mtdPlan: 32, mtdActual: 28, status: 'Behind' },
  { product: 'AQ-JT150 Jet Pump', plant: 'Hosur', planned: 80, actual: 74, var: -7.5, mtdPlan: 320, mtdActual: 298, status: 'Behind' },
  { product: 'AQ-S500 Submersible Pump', plant: 'Pune', planned: 12, actual: 12, var: 0.0, mtdPlan: 48, mtdActual: 48, status: 'On Track' },
];
