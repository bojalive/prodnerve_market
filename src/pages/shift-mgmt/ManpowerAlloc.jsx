...
const ALLOCATIONS = [
  ...
  { empId: 'EMP-1055', name: 'R. Selvam', skill: 'CNC Operator', grade: 'B', machine: 'CNC-A02', dept: 'CNC Bay 1', shift: 'A', from: '23 Mar', to: '28 Mar', status: 'Active' },
  ...
  { empId: 'EMP-1091', name: 'S. Murugan', skill: 'CNC Operator', grade: 'A', machine: 'CNC-A03', dept: 'CNC Bay 1', shift: 'B', from: '23 Mar', to: '28 Mar', status: 'Active' },
  { empId: 'EMP-1104', name: 'P. Kumar', skill: 'VMC Operator', grade: 'B', machine: 'VMC-B01', dept: 'VMC Bay', shift: 'A', from: '23 Mar', to: '28 Mar', status: 'Active' },
  { empId: 'EMP-1117', name: 'A. Babu', skill: 'Welder', grade: 'A', machine: 'WLD-01', dept: 'Welding', shift: 'A', from: '23 Mar', to: '28 Mar', status: 'Active' },
  { empId: 'EMP-1129', name: 'T. Ganesh', skill: 'Assembly Fitter', grade: 'A', machine: 'ASM-D02', dept: 'Assembly', shift: 'B', from: '23 Mar', to: '28 Mar', status: 'Active' },
  { empId: 'EMP-1135', name: 'N. Senthil', skill: 'Test Engineer', grade: 'A', machine: 'TST-E01', dept: 'Testing', shift: 'A', from: '23 Mar', to: '28 Mar', status: 'Active' },
  ...
  { empId: 'EMP-1165', name: 'M. Prakash', skill: 'Grinder Operator', grade: 'B', machine: 'GRD-C02', dept: 'Grinding', shift: 'B', from: '23 Mar', to: '28 Mar', status: 'Active' },
  { empId: 'EMP-1178', name: 'S. Ramesh', skill: 'VMC Operator', grade: 'A', machine: 'VMC-B02', dept: 'VMC Bay', shift: 'B', from: '23 Mar', to: '28 Mar', status: 'Active' },
