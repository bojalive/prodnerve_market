...
export default function ShiftHandoverForm() {
  ...
  const HISTORY = [
    { id: 'HO-501', shift: 'C to A', date: '23 Mar 06:00', outgoing: 'Anand M', incoming: 'Karthik V', issues: 2, ack: 'Yes', status: 'Complete' },
    { id: 'HO-500', shift: 'B to C', date: '22 Mar 22:00', outgoing: 'Saravanan T', incoming: 'Anand M', issues: 3, ack: 'Yes', status: 'Complete' },
    { id: 'HO-499', shift: 'A to B', date: '22 Mar 14:00', outgoing: 'Karthik V', incoming: 'Saravanan T', issues: 1, ack: 'Yes', status: 'Complete' },
    { id: 'HO-498', shift: 'C to A', date: '22 Mar 06:00', outgoing: 'Anand M', incoming: 'Karthik V', issues: 0, ack: 'Yes', status: 'Complete' },
    { id: 'HO-497', shift: 'B to C', date: '21 Mar 22:00', outgoing: 'Saravanan T', incoming: 'Anand M', issues: 4, ack: 'Yes', status: 'Complete' },
    { id: 'HO-496', shift: 'A to B', date: '21 Mar 14:00', outgoing: 'Karthik V', incoming: 'Saravanan T', issues: 2, ack: 'Pending', status: 'Pending' },
  ];
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 14 }}>
          ...
          <FormField label="Outgoing Supervisor">
            <select className="form-select" value={form.outgoing} onChange={e => set('outgoing', e.target.value)}>
              <option value="">-- Select --</option><option>Karthik V</option><option>Saravanan T</option><option>Anand M</option>
            </select>
          </FormField>
