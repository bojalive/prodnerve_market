...
export default function ShiftHandoverForm() {
  ...
  const HISTORY = [
    { id: 'HO-501', shift: 'C to A', date: '23 Mar 06:00', outgoing: 'Anand S', incoming: 'Suresh K', issues: 2, ack: 'Yes', status: 'Complete' },
    { id: 'HO-500', shift: 'B to C', date: '22 Mar 22:00', outgoing: 'Saravanan M', incoming: 'Anand S', issues: 3, ack: 'Yes', status: 'Complete' },
    { id: 'HO-499', shift: 'A to B', date: '22 Mar 14:00', outgoing: 'Suresh K', incoming: 'Saravanan M', issues: 1, ack: 'Yes', status: 'Complete' },
    { id: 'HO-498', shift: 'C to A', date: '22 Mar 06:00', outgoing: 'Anand S', incoming: 'Suresh K', issues: 0, ack: 'Yes', status: 'Complete' },
    { id: 'HO-497', shift: 'B to C', date: '21 Mar 22:00', outgoing: 'Saravanan M', incoming: 'Anand S', issues: 4, ack: 'Yes', status: 'Complete' },
    { id: 'HO-496', shift: 'A to B', date: '21 Mar 14:00', outgoing: 'Suresh K', incoming: 'Saravanan M', issues: 2, ack: 'Pending', status: 'Pending' },
  ];
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 14 }}>
          ...
          <FormField label="Outgoing Supervisor">
            <select className="form-select" value={form.outgoing} onChange={e => set('outgoing', e.target.value)}>
              <option value="">-- Select --</option><option>Suresh K</option><option>Saravanan M</option><option>Anand S</option>
            </select>
          </FormField>
