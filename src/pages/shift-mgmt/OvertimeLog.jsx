...
const OT_ENTRIES = [
  ...
  { id: 'OT-3003', empId: 'EMP-1218', name: 'P. Dhanush', dept: 'Maintenance', shift: 'A', date: '23 Mar', hours: 4.2, reason: 'CNC-A06 spindle bearing repair', approvedBy: 'Ganesan T', rate: '2.0x', amount: '2,520', status: 'Approved' },
  ...
  { id: 'OT-3007', empId: 'EMP-1129', name: 'T. Greg', dept: 'Assembly', shift: 'B', date: '21 Mar', hours: 2.5, reason: 'AQ-OW400 assembly completion', approvedBy: 'Arun S', rate: '1.5x', amount: '1,125', status: 'Approved' },
  ...
  { id: 'OT-3009', empId: 'EMP-1165', name: 'M. Patrick', dept: 'Grinding', shift: 'B', date: '21 Mar', hours: 2.0, reason: 'Grinding backlog', approvedBy: 'Arun S', rate: '1.5x', amount: '900', status: 'Approved' },
  { id: 'OT-3010', empId: 'EMP-1244', name: 'S. Dinesh', dept: 'Maintenance', shift: 'B', date: '20 Mar', hours: 3.0, reason: 'GRD-C04 motor rewind support', approvedBy: 'Ganesan T', rate: '1.5x', amount: '1,350', status: 'Approved' },
];
