...
const OT_ENTRIES = [
  ...
  { id: 'OT-3002', empId: 'EMP-1135', name: 'N. Senthil', dept: 'Testing', shift: 'A', date: '23 Mar', hours: 3.5, reason: 'Performance test EG-4022-CBE', approvedBy: 'Scott M', rate: '1.5x', amount: '1,575', status: 'Approved' },
  ...
  { id: 'OT-3006', empId: 'EMP-1152', name: 'R. Karthik', dept: 'CNC Bay 2', shift: 'A', date: '22 Mar', hours: 1.5, reason: 'Urgent part for maintenance', approvedBy: 'Mike R', rate: '1.5x', amount: '675', status: 'Approved' },
  { id: 'OT-3007', empId: 'EMP-1129', name: 'T. Ganesh', dept: 'Assembly', shift: 'B', date: '21 Mar', hours: 2.5, reason: 'HC-500 assembly completion', approvedBy: 'Andrew S', rate: '1.5x', amount: '1,125', status: 'Approved' },
