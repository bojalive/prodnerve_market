...
const OT_ENTRIES = [
  { id: 'OT-3001', empId: 'EMP-1063', name: 'V. Rajan', dept: 'Grinding', shift: 'A', date: '23 Mar', hours: 2.3, reason: 'Urgent WO-2526-10001 completion', approvedBy: 'Karthik V', rate: '1.5x', amount: '1,035', status: 'Approved' },
  { id: 'OT-3002', empId: 'EMP-1135', name: 'N. Stan', dept: 'Testing', shift: 'A', date: '23 Mar', hours: 3.5, reason: 'Performance test IC-4022-PCL', approvedBy: 'Saravanan T', rate: '1.5x', amount: '1,575', status: 'Approved' },
  ...
  { id: 'OT-3004', empId: 'EMP-1042', name: 'M. Kannan', dept: 'CNC Bay 1', shift: 'A', date: '22 Mar', hours: 2.0, reason: 'Setup for new program O3001', approvedBy: 'Karthik V', rate: '1.5x', amount: '900', status: 'Approved' },
  ...
  { id: 'OT-3006', empId: 'EMP-1152', name: 'R. Karl', dept: 'CNC Bay 2', shift: 'A', date: '22 Mar', hours: 1.5, reason: 'Urgent part for maintenance', approvedBy: 'Karthik V', rate: '1.5x', amount: '675', status: 'Approved' },
  { id: 'OT-3007', empId: 'EMP-1129', name: 'T. Greg', dept: 'Assembly', shift: 'B', date: '21 Mar', hours: 2.5, reason: 'HC-500 assembly completion', approvedBy: 'Anand M', rate: '1.5x', amount: '1,125', status: 'Approved' },
  { id: 'OT-3008', empId: 'EMP-1055', name: 'R. Hansen', dept: 'CNC Bay 1', shift: 'A', date: '21 Mar', hours: 4.0, reason: 'Saturday production shift', approvedBy: 'Karthik V', rate: '2.0x', amount: '2,400', status: 'Pending' },
