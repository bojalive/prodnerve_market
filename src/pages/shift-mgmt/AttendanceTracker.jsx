...
const ATTENDANCE = [
  ...
  { empId: 'EMP-1055', name: 'R. Selvam', dept: 'CNC Bay 1', shift: 'A', inTime: '06:02', outTime: '14:00', hours: 8.0, ot: 0, status: 'Present' },
  ...
  { empId: 'EMP-1091', name: 'S. Murugan', dept: 'CNC Bay 1', shift: 'B', inTime: '14:00', outTime: '22:02', hours: 8.0, ot: 0, status: 'Present' },
  { empId: 'EMP-1104', name: 'P. Kumar', dept: 'VMC Bay', shift: 'A', inTime: '05:58', outTime: '14:00', hours: 8.0, ot: 0, status: 'Present' },
  { empId: 'EMP-1117', name: 'A. Babu', dept: 'Welding', shift: 'A', inTime: '--', outTime: '--', hours: 0, ot: 0, status: 'Absent' },
  { empId: 'EMP-1129', name: 'T. Ganesh', dept: 'Assembly', shift: 'B', inTime: '13:55', outTime: '22:00', hours: 8.1, ot: 0, status: 'Present' },
  { empId: 'EMP-1135', name: 'N. Senthil', dept: 'Testing', shift: 'A', inTime: '06:00', outTime: '17:30', hours: 11.5, ot: 3.5, status: 'Present' },
  ...
  { empId: 'EMP-1165', name: 'M. Prakash', dept: 'Grinding', shift: 'B', inTime: '14:02', outTime: '22:00', hours: 8.0, ot: 0, status: 'Present' },
  { empId: 'EMP-1178', name: 'S. Ramesh', dept: 'VMC Bay', shift: 'B', inTime: '14:00', outTime: '22:05', hours: 8.1, ot: 0, status: 'Present' },
