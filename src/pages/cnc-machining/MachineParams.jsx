...
const PARAM_LOG = [
  { machine: 'CNC-A01', time: '23 Mar 14:00', spindleTemp: 42, coolantConc: 8.2, pressure: 6.4, vibration: 1.8, operator: 'Murugan R', status: 'OK' },
  { machine: 'CNC-A01', time: '23 Mar 10:00', spindleTemp: 40, coolantConc: 8.4, pressure: 6.5, vibration: 1.6, operator: 'Murugan R', status: 'OK' },
  { machine: 'CNC-A02', time: '23 Mar 14:00', spindleTemp: 45, coolantConc: 7.8, pressure: 6.2, vibration: 2.4, operator: 'Senthil M', status: 'Warn' },
  { machine: 'CNC-A02', time: '23 Mar 10:00', spindleTemp: 43, coolantConc: 8.0, pressure: 6.3, vibration: 2.1, operator: 'Senthil M', status: 'OK' },
  { machine: 'CNC-A03', time: '23 Mar 14:00', spindleTemp: 38, coolantConc: 8.6, pressure: 6.6, vibration: 1.2, operator: 'Kannan V', status: 'OK' },
  { machine: 'VMC-B01', time: '23 Mar 14:00', spindleTemp: 44, coolantConc: 7.5, pressure: 6.1, vibration: 2.0, operator: 'Kannan V', status: 'OK' },
  { machine: 'VMC-B02', time: '23 Mar 14:00', spindleTemp: 48, coolantConc: 7.2, pressure: 5.8, vibration: 2.8, operator: 'Selvam P', status: 'Warn' },
  { machine: 'GRD-C01', time: '23 Mar 14:00', spindleTemp: 36, coolantConc: 9.0, pressure: 6.8, vibration: 0.8, operator: 'Durai N', status: 'OK' },
];
