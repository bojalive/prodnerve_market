...
const PARAM_LOG = [
  { machine: 'CNC-A01', time: '23 Mar 14:00', spindleTemp: 42, coolantConc: 8.2, pressure: 6.4, vibration: 1.8, operator: 'Ravi K', status: 'OK' },
  { machine: 'CNC-A01', time: '23 Mar 10:00', spindleTemp: 40, coolantConc: 8.4, pressure: 6.5, vibration: 1.6, operator: 'Ravi K', status: 'OK' },
  { machine: 'CNC-A02', time: '23 Mar 14:00', spindleTemp: 45, coolantConc: 7.8, pressure: 6.2, vibration: 2.4, operator: 'Suresh M', status: 'Warn' },
  { machine: 'CNC-A02', time: '23 Mar 10:00', spindleTemp: 43, coolantConc: 8.0, pressure: 6.3, vibration: 2.1, operator: 'Suresh M', status: 'OK' },
  ...
  { machine: 'VMC-B02', time: '23 Mar 14:00', spindleTemp: 48, coolantConc: 7.2, pressure: 5.8, vibration: 2.8, operator: 'Vijay P', status: 'Warn' },
