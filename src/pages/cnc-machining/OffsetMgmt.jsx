...
const OFFSETS = [
  { machine: 'CNC-A01', tool: 'T01', type: 'Wear', axis: 'X', nominal: 0.000, current: -0.012, limit: 0.050, updatedBy: 'Karthik V', time: '23 Mar 14:10', status: 'OK' },
  { machine: 'CNC-A01', tool: 'T03', type: 'Wear', axis: 'Z', nominal: 0.000, current: -0.024, limit: 0.050, updatedBy: 'Karthik V', time: '23 Mar 14:10', status: 'OK' },
  { machine: 'CNC-A01', tool: 'T07', type: 'Geometry', axis: 'X', nominal: -42.580, current: -42.592, limit: 0.030, updatedBy: 'Karthik V', time: '23 Mar 11:30', status: 'Warn' },
  ...
  { machine: 'VMC-B02', tool: 'T01', type: 'Wear', axis: 'X', nominal: 0.000, current: -0.042, limit: 0.050, updatedBy: 'Ramesh S', time: '23 Mar 11:00', status: 'Warn' },
  { machine: 'VMC-B02', tool: 'T08', type: 'Geometry', axis: 'Z', nominal: -76.220, current: -76.225, limit: 0.015, updatedBy: 'Ramesh S', time: '23 Mar 08:30', status: 'OK' },
];
