...
const PROGRAMS = [
  { id: 'O1001', name: 'EG22-ROTOR-OP10', machine: 'CNC-A01', part: 'EG-22 Rotor', rev: 'C3', author: 'Ramesh T', verified: '18 Mar 2026', cycleTime: '8m 42s', status: 'Active' },
  { id: 'O1002', name: 'EG22-ROTOR-OP20', machine: 'CNC-A01', part: 'EG-22 Rotor', rev: 'C3', author: 'Ramesh T', verified: '18 Mar 2026', cycleTime: '6m 18s', status: 'Active' },
  { id: 'O2001', name: 'TS5-BODY-OP10', machine: 'CNC-A02', part: 'TS-5 Body', rev: 'B2', author: 'Ganesh S', verified: '12 Mar 2026', cycleTime: '4m 55s', status: 'Active' },
  { id: 'O2002', name: 'TS5-BODY-OP20', machine: 'VMC-B01', part: 'TS-5 Body', rev: 'B2', author: 'Ganesh S', verified: '12 Mar 2026', cycleTime: '7m 30s', status: 'Active' },
  { id: 'O3001', name: 'AB30-STATOR-OP10', machine: 'CNC-A03', part: 'AB-30 Stator', rev: 'A1', author: 'Pradeep M', verified: '20 Mar 2026', cycleTime: '12m 05s', status: 'Under Review' },
  { id: 'O3002', name: 'EG37-HOUSING-OP10', machine: 'VMC-B02', part: 'EG-37 Housing', rev: 'D1', author: 'Ramesh T', verified: '15 Mar 2026', cycleTime: '14m 22s', status: 'Active' },
  { id: 'O4001', name: 'EG55-SHAFT-OP10', machine: 'CNC-A05', part: 'EG-55 Shaft', rev: 'B1', author: 'Ganesh S', verified: '10 Mar 2026', cycleTime: '9m 48s', status: 'Active' },
